...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - x;
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_global_offset(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_local_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_group_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = (-2) + get_global_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = 0;
    data[(get_global_id(1) * 4) / 4] = 0;
    data[(get_global_id(2) * 4) / 4] = 0;
}
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_global_size(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_num_groups(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) - get_work_dim();
...
__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_x_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = x - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_global_offset_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_offset(0) - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_local_id_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_local_id(0) - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_group_id_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_group_id(0) - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_local_size_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = 64 - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_global_id_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = 0;
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_global_size_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_size(0) - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_num_groups_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_num_groups(0) - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void substract_get_work_dim(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_work_dim() - get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_x_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = x - get_global_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_global_offset_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_offset(0) - get_global_offset(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_local_id_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_local_id(0) - get_local_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_group_id_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_group_id(0) - get_group_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_local_size_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = 0;
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_global_id_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(0) - get_global_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_global_size_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_size(0) - get_global_size(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_num_groups_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_num_groups(0) - get_num_groups(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void substract_get_work_dim_8_8(int x, __global uint *data)
{
