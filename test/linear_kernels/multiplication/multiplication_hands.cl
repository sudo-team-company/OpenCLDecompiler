...
{
    data[(get_global_id(0) * 4) / 4] = get_local_id(0) * get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = get_local_id(1) * get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = get_local_id(2) * get_local_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (((get_global_id(0) - get_global_offset(0)) + get_global_offset(0)) * 2) * 2;
