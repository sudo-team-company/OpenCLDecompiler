...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_local_id(0) * get_global_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_group_id(0) * get_global_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) * 2;
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_id(0) * get_global_id(0);
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_global_size(0) * get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = get_global_size(1) * get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = get_global_size(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_num_groups(0) * get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = get_num_groups(1) * get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = get_num_groups(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) - get_global_offset(0)) / 4] = get_work_dim() * get_global_id(0);
