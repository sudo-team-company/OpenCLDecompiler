/* Disassembling 'unused_params\four_unused_params\four_unused_params-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
.kernel four_unused_params
    ...
    .control_directive
        .fill 128, 1, 0x00
    .config
        .md_symname "four_unused_params@kd"
        ...
        .arg data2, "int*", 8, 8, globalbuf, struct, global, default
...
/*000000000108*/ s_load_dwordx2  s[10:11], s[6:7], 0x38
/*000000000110*/ s_waitcnt       lgkmcnt(0)
/*000000000114*/ s_clause        0x2
/*000000000118*/ s_load_dword    s11, s[6:7], 0x0
/*000000000120*/ s_load_dwordx2  s[0:1], s[6:7], 0x18
/*000000000128*/ s_load_dwordx2  s[2:3], s[6:7], 0x30
...
/*000000000148*/ s_add_u32       s10, s6, 56
...
/*000000000174*/ s_load_dwordx2  s[6:7], s[6:7], 0x28
