...
.kernel four_unused_params
    .config
        ...
        .arg n, "int", int
        .arg data2, "int*", int*, global, , rdonly
        .arg w, "int", int
        .arg z, "int", int
...
/*000000000034*/ s_load_dwordx2  s[2:3], s[6:7], 0x48
/*00000000003c*/ s_and_saveexec_b64 s[4:5], vcc
/*000000000040*/ s_cbranch_execz .L116_0
/*000000000044*/ s_load_dword    s1, s[6:7], 0x60
...
/*00000000008c*/ s_load_dwordx2  s[12:13], s[6:7], 0x58
...
/*0000000000c4*/ s_load_dword    s0, s[6:7], 0x64
