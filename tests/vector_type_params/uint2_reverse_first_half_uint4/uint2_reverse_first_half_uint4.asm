/* Disassembling 'vector_type_params\uint2_reverse_first_half_uint4\uint2_reverse_first_half_uint4.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
.kernel uint2_reverse_first_half_uint4
    .config
        .dims x
        .cws 64, 1, 1
        .sgprsnum 17
...
/*000000000054*/ s_waitcnt       vmcnt(0) & lgkmcnt(0)
/*000000000058*/ v_mov_b32       v4, v2
/*00000000005c*/ flat_store_dwordx2 v[0:1], v[3:4]
