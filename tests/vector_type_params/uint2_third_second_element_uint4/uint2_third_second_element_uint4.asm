/* Disassembling 'vector_type_params\uint2_third_second_element_uint4\uint2_third_second_element_uint4.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
.kernel uint2_third_second_element_uint4
    .config
        .dims x
        .cws 64, 1, 1
        .sgprsnum 17
...
/*000000000038*/ v_add_u32       v2, vcc, v2, 4
