...
{
    data[get_global_id(0) - get_global_offset(0)] = (uint)-2 + get_global_id(0);
    data[get_global_id(1)] = (uint)-2 + get_global_id(1);
    data[get_global_id(2)] = (uint)-4 + get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_work_dim() + (uint)-2;
    data[get_global_id(1)] = get_work_dim() + (uint)-2;
    data[get_global_id(2)] = get_work_dim() + (uint)-4;
}
