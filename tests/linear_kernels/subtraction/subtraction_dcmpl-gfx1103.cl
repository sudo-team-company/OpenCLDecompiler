...
void subtract_get_global_id_get_global_offset(int arg0, __global uint *arg1)
{
    ...
    arg1[get_global_id(1) - get_global_offset(1)] = get_global_id(1) - get_global_offset(1);
    arg1[get_global_id(2) - get_global_offset(2)] = get_global_id(2) - get_global_offset(2);
}
...
{
    arg0[get_global_id(0)] = get_local_id(0) + get_global_size(0);
    arg0[get_global_id(1)] = get_local_id(1) + get_global_size(1);
    arg0[get_global_id(2)] = get_local_id(2) + get_global_size(2);
}
...
{
    arg0[get_global_offset(0)] = arg1 - get_global_offset(0);
    arg0[get_global_id(1) - get_global_offset(1)] = arg1 - get_global_id(1) - get_global_offset(1);
    arg0[get_global_id(2) - get_global_offset(2)] = arg1 - get_global_id(2) - get_global_offset(2);
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = get_local_size(0) - get_global_id(0) - get_global_offset(0);
    arg1[get_global_id(1) - get_global_offset(1)] = get_local_size(1) - get_global_id(1) - get_global_offset(1);
    arg1[get_global_id(2) - get_global_offset(2)] = get_local_size(2) - get_global_id(2) - get_global_offset(2);
}
...
{
    arg0[get_global_id(0) - get_global_offset(0)] = get_global_offset(0) - get_global_id(0) + get_global_size(0);
    arg0[get_global_id(1) - get_global_offset(1)] = get_global_offset(1) - get_global_id(1) + get_global_size(1);
    arg0[get_global_id(2) - get_global_offset(2)] = get_global_offset(2) - get_global_id(2) + get_global_size(2);
}
...
{
    arg1[get_global_id(0)] = get_local_id(0) - get_global_size(0);
    arg1[get_global_id(1)] = get_local_id(1) - get_global_size(1);
    arg1[get_global_id(2)] = get_local_id(2) - get_global_size(2);
}
...
{
    arg0[get_global_id(0)] = (get_num_groups(0) * (int)15) + (get_group_id(0) * get_local_size(0));
    arg0[get_global_id(1)] = get_num_groups(1) + (get_group_id(1) * get_local_size(1));
    arg0[get_global_id(2)] = get_num_groups(2) + (get_group_id(2) * get_local_size(2));
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = (uint)arg0 - get_global_id(0) - get_global_offset(0);
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = get_global_offset(0) - get_global_id(0) + get_global_size(0);
}
...
{
    arg1[get_global_id(0)] = (uint)arg0 - get_global_id(1);
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = get_global_id(0) - get_global_offset(0) - get_global_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void subtract_get_global_size_8_8(int arg0, __global uint *arg1)
{
    arg1[get_global_id(0)] = (get_group_id(0) * get_local_size(0)) - (get_group_id(1) * get_local_size(1));
}
...
{
    arg1[get_global_id(0)] = (long)0;
    arg1[get_global_id(1)] = (long)0;
    arg1[get_global_id(2)] = (long)0;
}
...
{
    arg0[get_global_id(0) - get_global_offset(0)] = arg1 - get_global_id(0) - get_global_offset(0);
    arg0[get_global_id(1) - get_global_offset(1)] = arg1 - get_global_id(1) - get_global_offset(1);
    arg0[get_global_id(2) - get_global_offset(2)] = arg1 - get_global_id(2) - get_global_offset(2);
}
...
{
    arg0[get_global_id(0)] = get_global_size(0) - get_num_groups(0);
    arg0[get_global_id(1)] = get_global_size(1) - get_num_groups(1);
    arg0[get_global_id(2)] = get_global_size(2) - get_num_groups(2);
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = (ulong)arg0 - get_global_id(0) - get_global_offset(0);
}
...
{
    arg1[get_global_id(0)] = (ulong)arg0 - get_global_id(1);
}
...
{
    arg0[get_global_id(0)] = (char)arg1 + get_global_size(0);
    arg0[get_global_id(1)] = (char)arg1 + get_global_size(1);
    arg0[get_global_id(2)] = (char)arg1 + get_global_size(2);
}
...
{
    arg0[get_global_id(0)] = (char)arg1 - get_global_offset(0);
    arg0[get_global_id(1)] = (char)arg1 - get_global_offset(1);
    arg0[get_global_id(2)] = (char)arg1 - get_global_offset(2);
}
...
{
    arg1[get_group_id(0)*get_local_size(0) + get_local_id(0)] = get_global_offset(0) + (get_group_id(0) * get_local_size(0));
    arg1[get_global_id(1) - get_global_offset(1)] = get_global_id(1) - get_global_offset(1) - get_local_id(1);
    arg1[get_global_id(2) - get_global_offset(2)] = get_global_id(2) - get_global_offset(2) - get_local_id(2);
}
...
{
    arg0[get_global_id(0)] = (char)arg1 - get_local_size(0);
    arg0[get_global_id(1)] = (char)arg1 - get_local_size(1);
    arg0[get_global_id(2)] = (char)arg1 - get_local_size(2);
}
...
{
    arg0[get_global_id(0) - get_global_offset(0)] = (char)arg1 - get_global_id(0) - get_global_offset(0);
    arg0[get_global_id(1) - get_global_offset(1)] = (char)arg1 - get_global_id(1) - get_global_offset(1);
    arg0[get_global_id(2) - get_global_offset(2)] = (char)arg1 - get_global_id(2) - get_global_offset(2);
}
...
{
    arg0[get_global_id(0)] = (char)arg1 - get_num_groups(0);
    arg0[get_global_id(1)] = (char)arg1 - get_num_groups(1);
    arg0[get_global_id(2)] = (char)arg1 - get_num_groups(2);
}
...
{
    arg0[get_global_id(0)] = (char)arg1 - get_work_dim();
    arg0[get_global_id(1)] = (char)arg1 - get_work_dim();
    arg0[get_global_id(2)] = (char)arg1 - get_work_dim();
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = (uchar)arg0 - get_global_id(0) - get_global_offset(0);
}
...
{
    arg1[get_global_id(0)] = (uchar)arg0 - get_global_id(1);
}
...
{
    arg1[get_global_id(0) - get_global_offset(0)] = (get_group_id(1) * (uchar)-8) + get_global_id(0) - get_global_offset(1) - get_local_id(1) - get_global_offset(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void subtract_char_get_global_size_8_8(int arg0, __global uchar *arg1)
{
    arg1[get_global_id(0)] = get_global_size(0) - get_global_size(1);
}
...
{
    arg1[get_global_id(0)] = get_work_dim() + (get_group_id(1) * (uchar)-8) - get_global_offset(1) - get_local_id(1);
}
