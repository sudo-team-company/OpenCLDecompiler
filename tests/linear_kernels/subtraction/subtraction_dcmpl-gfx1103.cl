...
{
    arg1[get_global_id(0)] = 0 - (uint)(get_global_id(0) + -get_global_offset(0));
    arg1[get_global_id(1)] = 0 - (uint)(get_global_id(1) + -get_global_offset(1));
    arg1[get_global_id(2)] = 0 - (uint)(get_global_id(2) + -get_global_offset(2));
}
...
{
    arg1[get_global_id(0)] = (uint)get_work_dim() - get_global_id(1);
}
...
{
    arg1[get_global_id(0)] = (ulong)get_work_dim() - get_num_groups(0);
    arg1[get_global_id(1)] = (ulong)get_work_dim() - get_num_groups(1);
    arg1[get_global_id(2)] = (ulong)get_work_dim() - get_num_groups(2);
}
