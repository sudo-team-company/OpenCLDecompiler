...
{
    data[get_global_id(0)] = (x - (get_group_id(1) * get_local_size(1))) - (get_global_offset(1) + get_local_id(1));
}
...
{
    data[get_global_id(0)] = 0xf8 + get_local_id(0);
    data[get_global_id(1)] = 0xfc + get_local_id(1);
    data[get_global_id(2)] = 0xfe + get_local_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void subtract_char_get_group_id_get_local_size(int x, __global char *data)
{
    data[get_global_id(0)] = get_group_id(0) + 0xfe;
    data[get_global_id(1)] = get_group_id(1) + 0xf0;
    data[get_global_id(2)] = get_group_id(2) + 0xfe;
}
...
{
    data[get_global_id(0)] = get_global_size(0) + 0xf0;
    data[get_global_id(1)] = get_global_size(1) + 0xfe;
    data[get_global_id(2)] = get_global_size(2) + 0xfe;
}
