...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_offset(0) + ((get_global_id(0) - get_global_offset(0)) - (uint)x);
...
{
    data[get_global_id(0)] = get_work_dim() - (uint)get_global_offset(0);
    data[get_global_id(1)] = get_work_dim() - (uint)get_global_offset(1);
    data[get_global_id(2)] = get_work_dim() - (uint)get_global_offset(2);
}
...
{
    data[get_global_id(0)] = 0 + (get_num_groups(0) - (uint)get_local_id(0));
    data[get_global_id(1)] = 0 + (get_num_groups(1) - (uint)get_local_id(1));
    data[get_global_id(2)] = 0 + (get_num_groups(2) - (uint)get_local_id(2));
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_work_dim_get_local_id(int x, __global uint *data)
{
    data[get_global_id(0)] = get_work_dim() - (uint)get_local_id(0);
    data[get_global_id(1)] = get_work_dim() - (uint)get_local_id(1);
    data[get_global_id(2)] = get_work_dim() - (uint)get_local_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_offset(0) + ((get_global_id(0) - get_global_offset(0)) - (uint)get_group_id(0));
...
{
    data[get_global_id(0)] = get_work_dim() - (uint)get_group_id(0);
    data[get_global_id(1)] = get_work_dim() - (uint)get_group_id(1);
    data[get_global_id(2)] = get_work_dim() - (uint)get_group_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) + (-2);
...
{
    data[get_global_id(0)] = 0 + (get_num_groups(0) - get_global_id(0));
    data[get_global_id(1)] = 0 + (get_num_groups(1) - get_global_id(1));
    data[get_global_id(2)] = 0 + (get_num_groups(2) - get_global_id(2));
}
...
{
    data[get_global_id(0)] = get_work_dim() - (uint)get_global_size(0);
    data[get_global_id(1)] = get_work_dim() - (uint)get_global_size(1);
    data[get_global_id(2)] = get_work_dim() - (uint)get_global_size(2);
}
...
{
    data[get_global_id(0)] = 2 + (0 - get_num_groups(0));
    data[get_global_id(1)] = 2 + (0 - get_num_groups(1));
    data[get_global_id(2)] = 4 + (0 - get_num_groups(2));
}
...
{
    data[get_global_id(0)] = (uint)x - get_work_dim();
    data[get_global_id(1)] = (uint)x - get_work_dim();
    data[get_global_id(2)] = (uint)x - get_work_dim();
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void subtract_get_global_offset_get_work_dim(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)get_global_offset(0) - get_work_dim();
    data[get_global_id(1)] = (uint)get_global_offset(1) - get_work_dim();
    data[get_global_id(2)] = (uint)get_global_offset(2) - get_work_dim();
}

__kernel __attribute__((reqd_work_group_size(8, 4, 2)))
void subtract_get_local_id_get_work_dim(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)get_local_id(0) - get_work_dim();
    data[get_global_id(1)] = (uint)get_local_id(1) - get_work_dim();
    data[get_global_id(2)] = (uint)get_local_id(2) - get_work_dim();
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void subtract_get_group_id_get_work_dim(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)get_group_id(0) - get_work_dim();
    data[get_global_id(1)] = (uint)get_group_id(1) - get_work_dim();
    data[get_global_id(2)] = (uint)get_group_id(2) - get_work_dim();
}
...
{
    data[get_global_id(0)] = (uint)get_global_size(0) - get_work_dim();
    data[get_global_id(1)] = (uint)get_global_size(1) - get_work_dim();
    data[get_global_id(2)] = (uint)get_global_size(2) - get_work_dim();
}
...
void subtract_get_num_groups_get_work_dim(int x, __global uint *data)
{
    ...
    data[get_global_id(2)] = 0 + (get_num_groups(2) - get_work_dim());
}
...
{
    data[get_global_id(0)] = get_work_dim() - (ushort)get_local_id(0);
    data[get_global_id(1)] = get_work_dim() - (ushort)get_local_id(1);
    data[get_global_id(2)] = get_work_dim() - (ushort)get_local_id(2);
}
...
void subtract_char_get_global_offset_get_local_size(int x, __global char *data)
{
    ...
    data[get_global_id(1)] = (int)get_global_offset(1) + 0xf0;
...
{
    data[get_global_id(0)] = 0xf8 + (ulong)get_local_id(0);
    data[get_global_id(1)] = 0xfc + (ulong)get_local_id(1);
    data[get_global_id(2)] = 0xfe + (ulong)get_local_id(2);
}
...
void subtract_char_get_group_id_get_local_size(int x, __global char *data)
{
    ...
    data[get_global_id(1)] = (int)get_group_id(1) + 0xf0;
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) + (-2);
    data[get_global_id(1)] = (ulong)get_global_id(1) + (-2);
    data[get_global_id(2)] = (ulong)get_global_id(2) + (-4);
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void subtract_char_get_global_size_get_local_size(__global char *data, int x)
{
    data[get_global_id(0)] = (ulong)get_global_size(0) + 0xf0;
...
{
    data[get_global_id(0)] = get_num_groups(0) + (ulong)0xfe;
    data[get_global_id(1)] = get_num_groups(1) + (ulong)0xfe;
...
{
    data[get_global_id(0)] = (ulong)get_work_dim() + (-2);
    data[get_global_id(1)] = (ulong)get_work_dim() + (-2);
    data[get_global_id(2)] = 0xfc + (ulong)get_work_dim();
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) - get_work_dim();
    data[get_global_id(1)] = (ushort)get_global_id(1) - get_work_dim();
    data[get_global_id(2)] = (ushort)get_global_id(2) - get_work_dim();
}
