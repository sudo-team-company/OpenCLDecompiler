...
{
    arg0[get_global_id(0)] = (get_num_groups(0) * 15) + (get_group_id(0) * get_local_size(0));
...
{
    arg1[get_global_id(0)] = get_global_size(0) - get_global_id(0);
}
...
{
    arg1[get_global_id(0)] = (((get_num_groups(0) - get_num_groups(1)) * 8) + (get_group_id(0) * get_local_size(0))) - (get_group_id(1) * get_local_size(1));
}
...
{
    arg1[get_global_id(0)] = (((get_group_id(1) * -8) + get_global_id(0)) - get_global_offset(1)) - get_local_id(1);
}
...
{
    arg1[get_global_id(0)] = ((get_work_dim() + (get_group_id(1) * -8)) - get_global_offset(1)) - get_local_id(1);
}
