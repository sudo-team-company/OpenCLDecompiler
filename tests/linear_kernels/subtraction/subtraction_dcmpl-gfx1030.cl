...
{
    data[get_global_id(0)] = (long)get_global_offset(0) - (long)x;
    data[get_global_id(1)] = (long)get_global_offset(1) - (long)x;
    data[get_global_id(2)] = (long)get_global_offset(2) - (long)x;
}
...
{
    data[get_global_id(0)] = (long)get_group_id(0) - (long)x;
    data[get_global_id(1)] = (long)get_group_id(1) - (long)x;
    data[get_global_id(2)] = (long)get_group_id(2) - (long)x;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_local_size_x(int x, __global uint *data)
{
    data[get_global_id(0)] = (long)2 - (long)x;
    data[get_global_id(1)] = (long)2 - (long)x;
    data[get_global_id(2)] = (long)4 - (long)x;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_global_id_x(int x, __global uint *data)
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_offset(0) + (ulong)((uint)(get_global_id(0) - get_global_offset(0)) - (uint)x);
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)x;
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)x;
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void subtract_get_global_size_x(__global int *data, int x)
{
    data[get_global_id(0)] = (long)get_global_size(0) - (long)x;
    data[get_global_id(1)] = (long)get_global_size(1) - (long)x;
    data[get_global_id(2)] = (long)get_global_size(2) - (long)x;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_num_groups_x(int x, __global uint *data)
{
    data[get_global_id(0)] = (long)get_num_groups(0) - (long)x;
    data[get_global_id(1)] = (long)get_num_groups(1) - (long)x;
    data[get_global_id(2)] = (long)get_num_groups(2) - (long)x;
}
...
{
    data[get_global_id(0)] = (long)x - (long)get_global_offset(0);
    data[get_global_id(1)] = (long)x - (long)get_global_offset(1);
    data[get_global_id(2)] = (long)x - (long)get_global_offset(2);
}
...
{
    data[get_global_id(0)] = (long)2 - (long)get_global_offset(0);
    data[get_global_id(1)] = (long)2 - (long)get_global_offset(1);
    data[get_global_id(2)] = (long)4 - (long)get_global_offset(2);
}
...
{
    data[get_global_id(0)] = (uint)2 - (uint)get_local_id(0);
    data[get_global_id(1)] = (uint)2 - (uint)get_local_id(1);
    data[get_global_id(2)] = (uint)4 - (uint)get_local_id(2);
}
...
void subtract_get_global_id_get_local_id(int x, __global uint *data)
{
    ...
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)get_local_id(1);
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)get_local_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)0 + (ulong)((uint)get_num_groups(0) - (uint)get_local_id(0));
    data[get_global_id(1)] = (ulong)0 + (ulong)((uint)get_num_groups(1) - (uint)get_local_id(1));
    data[get_global_id(2)] = (ulong)0 + (ulong)((uint)get_num_groups(2) - (uint)get_local_id(2));
}
...
{
    data[get_global_id(0)] = (long)x - (long)get_group_id(0);
    data[get_global_id(1)] = (long)x - (long)get_group_id(1);
    data[get_global_id(2)] = (long)x - (long)get_group_id(2);
}
...
{
    data[get_global_id(0)] = (long)2 - (long)get_group_id(0);
    data[get_global_id(1)] = (long)2 - (long)get_group_id(1);
    data[get_global_id(2)] = (long)4 - (long)get_group_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_global_id_get_group_id(int x, __global uint *data)
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_offset(0) + (ulong)((uint)(get_global_id(0) - get_global_offset(0)) - (uint)get_group_id(0));
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)get_group_id(1);
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)get_group_id(2);
}
...
{
    data[get_global_id(0)] = (uint)x - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)x - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)x - (uint)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void subtract_get_global_offset_get_global_id(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)0 - (uint)(get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = (uint)0 - (uint)(get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = (uint)0 - (uint)(get_global_id(2) - get_global_offset(2));
}

__kernel __attribute__((reqd_work_group_size(8, 4, 2)))
void subtract_get_local_id_get_global_id(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)get_local_id(0) - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)get_local_id(1) - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)get_local_id(2) - (uint)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void subtract_get_group_id_get_global_id(int x, __global int *data)
{
    data[get_global_id(0)] = (uint)get_group_id(0) - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)get_group_id(1) - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)get_group_id(2) - (uint)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_local_size_get_global_id(int x, __global uint *data)
{
    data[get_global_id(0)] = (uint)2 - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)2 - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)4 - (uint)get_global_id(2);
}
...
{
    data[get_global_id(0)] = (uint)get_global_size(0) - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)get_global_size(1) - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)get_global_size(2) - (uint)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_num_groups_get_global_id(int x, __global uint *data)
{
    data[get_global_id(0)] = (ulong)0 + (ulong)((uint)get_num_groups(0) - (uint)get_global_id(0));
    data[get_global_id(1)] = (ulong)0 + (ulong)((uint)get_num_groups(1) - (uint)get_global_id(1));
    data[get_global_id(2)] = (ulong)0 + (ulong)((uint)get_num_groups(2) - (uint)get_global_id(2));
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_work_dim_get_global_id(int x, __global uint *data)
{
    data[get_global_id(0)] = (uint)get_work_dim() - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)get_work_dim() - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)get_work_dim() - (uint)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void subtract_x_get_global_size(__global int *data, int x)
{
    data[get_global_id(0)] = (long)x - (long)get_global_size(0);
    data[get_global_id(1)] = (long)x - (long)get_global_size(1);
    data[get_global_id(2)] = (long)x - (long)get_global_size(2);
}
...
{
    data[get_global_id(0)] = (long)2 - (long)get_global_size(0);
    data[get_global_id(1)] = (long)2 - (long)get_global_size(1);
    data[get_global_id(2)] = (long)4 - (long)get_global_size(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_global_id_get_global_size(int x, __global uint *data)
{
    data[get_global_id(0) - get_global_offset(0)] = (uint)get_global_id(0) - (uint)get_global_size(0);
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)get_global_size(1);
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)get_global_size(2);
}
...
{
    data[get_global_id(0)] = (ulong)2 + (ulong)((uint)0 - (uint)get_num_groups(0));
    data[get_global_id(1)] = (ulong)2 + (ulong)((uint)0 - (uint)get_num_groups(1));
    data[get_global_id(2)] = (ulong)4 + (ulong)((uint)0 - (uint)get_num_groups(2));
}
...
{
    data[get_global_id(0)] = (uint)2 - (uint)get_work_dim();
    data[get_global_id(1)] = (uint)2 - (uint)get_work_dim();
    data[get_global_id(2)] = (uint)4 - (uint)get_work_dim();
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_get_global_id_get_work_dim(int x, __global uint *data)
{
    data[get_global_id(0) - get_global_offset(0)] = (uint)get_global_id(0) - (uint)get_work_dim();
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)get_work_dim();
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)get_work_dim();
}
...
{
    data[get_global_id(0)] = (uint)get_num_groups(0) - (uint)get_work_dim();
    data[get_global_id(1)] = (uint)get_num_groups(1) - (uint)get_work_dim();
    data[get_global_id(2)] = (ulong)0 + (ulong)((uint)get_num_groups(2) - (uint)get_work_dim());
}
...
{
    data[get_global_id(0)] = (uint)get_global_offset(0) - (uint)get_global_id(0);
}
...
{
    data[get_global_id(0)] = (uint)64 - (uint)get_global_id(0);
}
...
{
    data[get_global_id(0)] = (uint)((long)x - (long)(get_group_id(1) * 8)) - (uint)((ulong)get_global_offset(1) + (ulong)get_local_id(1));
}
...
{
    data[get_global_id(0)] = (uint)get_global_id(0) - (uint)get_global_id(1);
}
...
{
    data[get_global_id(0)] = (ulong)((long)get_num_groups(0) - (long)get_num_groups(1)) - (ulong)0;
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void subtract_get_work_dim_8_8(int x, __global uint *data)
{
    data[get_global_id(0)] = (uint)get_work_dim() - (uint)get_global_id(1);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) - get_global_offset(0);
    data[get_global_id(1)] = (ulong)get_global_id(1) - get_global_offset(1);
    data[get_global_id(2)] = (ulong)get_global_id(2) - get_global_offset(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) - get_group_id(0);
    data[get_global_id(1)] = (ulong)get_global_id(1) - get_group_id(1);
    data[get_global_id(2)] = (ulong)get_global_id(2) - get_group_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)0 - 0;
    data[get_global_id(1)] = (ulong)get_global_id(1) - get_global_id(1);
    data[get_global_id(2)] = (ulong)get_global_id(2) - get_global_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) - get_global_size(0);
    data[get_global_id(1)] = (ulong)get_global_id(1) - get_global_size(1);
    data[get_global_id(2)] = (ulong)get_global_id(2) - get_global_size(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) - get_num_groups(0);
    data[get_global_id(1)] = (ulong)get_global_id(1) - get_num_groups(1);
    data[get_global_id(2)] = (ulong)get_global_id(2) - get_num_groups(2);
}
...
{
    data[get_global_id(0)] = (uint)get_num_groups(0) - (uint)get_global_id(0);
}
...
{
    data[get_global_id(0)] = (ushort)2 - (ushort)x;
    data[get_global_id(1)] = (ushort)2 - (ushort)x;
    data[get_global_id(2)] = (long)4 - (long)x;
}
...
{
    data[get_global_id(0)] = (ushort)2 - (ushort)get_local_id(0);
    data[get_global_id(1)] = (ushort)2 - (ushort)get_local_id(1);
    data[get_global_id(2)] = (ushort)4 - (ushort)get_local_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)get_group_id(0) + (ulong)0xfe;
    data[get_global_id(1)] = (int)get_group_id(1) + (int)0xf0;
    data[get_global_id(2)] = (ulong)get_group_id(2) + (ulong)0xfe;
}
...
void subtract_char_get_global_size_get_local_size(__global char *data, int x)
{
    ...
    data[get_global_id(1)] = (ulong)get_global_size(1) + (ulong)0xfe;
    data[get_global_id(2)] = (ulong)get_global_size(2) + (ulong)0xfe;
}
...
{
    data[get_global_id(0)] = (ushort)0 - (ushort)(get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = (ushort)0 - (ushort)(get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = (ushort)0 - (ushort)(get_global_id(2) - get_global_offset(2));
}
...
{
    data[get_global_id(0)] = (ushort)2 - (ushort)get_global_id(0);
    data[get_global_id(1)] = (ushort)2 - (ushort)get_global_id(1);
    data[get_global_id(2)] = (ushort)4 - (ushort)get_global_id(2);
}
...
{
    data[get_global_id(0)] = (uint)get_num_groups(0) - (uint)get_global_id(0);
    data[get_global_id(1)] = (uint)get_num_groups(1) - (uint)get_global_id(1);
    data[get_global_id(2)] = (uint)get_num_groups(2) - (uint)get_global_id(2);
}
...
{
    data[get_global_id(0)] = (long)x - (long)get_num_groups(0);
    data[get_global_id(1)] = (long)x - (long)get_num_groups(1);
    data[get_global_id(2)] = (long)x - (long)get_num_groups(2);
}
...
{
    data[get_global_id(0)] = (long)2 - (long)get_num_groups(0);
    data[get_global_id(1)] = (long)2 - (long)get_num_groups(1);
    data[get_global_id(2)] = (long)4 - (long)get_num_groups(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void subtract_char_get_global_id_get_num_groups(int x, __global uchar *data)
{
    data[get_global_id(0) - get_global_offset(0)] = (uint)get_global_id(0) - (uint)get_num_groups(0);
    data[get_global_id(1)] = (uint)get_global_id(1) - (uint)get_num_groups(1);
    data[get_global_id(2)] = (uint)get_global_id(2) - (uint)get_num_groups(2);
}
...
{
    data[get_global_id(0)] = (uint)get_work_dim() - (uint)get_num_groups(0);
    data[get_global_id(1)] = (uint)get_work_dim() - (uint)get_num_groups(1);
    data[get_global_id(2)] = (uint)get_work_dim() - (uint)get_num_groups(2);
}
...
{
    data[get_global_id(0)] = (ushort)2 - (ushort)get_work_dim();
    data[get_global_id(1)] = (ushort)2 - (ushort)get_work_dim();
    data[get_global_id(2)] = (uint)4 - (uint)get_work_dim();
}
...
{
    data[get_global_id(0)] = (ushort)64 - (ushort)get_global_id(0);
}
