...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)x + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)x + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)x + (ulong)get_local_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)x + (ulong)2;
    data[(get_global_id(1) * 4) / 4] = (ulong)x + (ulong)2;
    data[(get_global_id(2) * 4) / 4] = (ulong)x + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_global_id_x(int x, __global uint *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)x) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)x + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)x + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_offset(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_offset(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_offset(2) + (ulong)get_local_id(2);
}
...
void add_get_local_size_get_global_offset(int x, __global uint *data)
{
    ...
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_offset(1) + (ulong)2;
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_offset(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_global_id_get_global_offset(int x, __global uint *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)get_global_offset(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_offset(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_offset(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_group_id(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_group_id(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_group_id(2) + (ulong)get_local_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_local_size_get_local_id(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)2 + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)2 + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)4 + (ulong)get_local_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_global_id_get_local_id(int x, __global uint *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)get_local_id(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_local_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_local_id(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void add_get_global_size_get_local_id(__global int *data, int x)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_size(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_size(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_size(2) + (ulong)get_local_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_num_groups_get_local_id(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_num_groups(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_num_groups(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_num_groups(2) + (ulong)get_local_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_work_dim_get_local_id(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_local_id(2);
}
...
void add_get_local_size_get_group_id(int x, __global uint *data)
{
    ...
    data[(get_global_id(1) * 4) / 4] = (ulong)get_group_id(1) + (ulong)2;
    data[(get_global_id(2) * 4) / 4] = (ulong)get_group_id(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_global_id_get_group_id(int x, __global uint *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)get_group_id(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)get_group_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_group_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)x + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)x + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)x + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_offset(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_offset(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_offset(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_local_id(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_local_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_local_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_group_id(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_group_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_group_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)2 + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)2 + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)4 + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_size(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_size(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_size(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_num_groups_get_global_id(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_num_groups(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_num_groups(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_num_groups(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_work_dim_get_global_id(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_size(0) + (ulong)2;
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_size(1) + (ulong)2;
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_size(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_get_global_id_get_global_size(int x, __global uint *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)get_global_size(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)get_global_size(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_global_size(2) + (ulong)get_global_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)get_num_groups(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)get_num_groups(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_num_groups(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_work_dim() + (ulong)x;
    data[(get_global_id(1) * 4) / 4] = (ulong)get_work_dim() + (ulong)x;
    data[(get_global_id(2) * 4) / 4] = (ulong)get_work_dim() + (ulong)x;
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = (ulong)((ulong)get_global_offset(0) + (ulong)get_work_dim()) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = (ulong)get_work_dim() + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)x) + (ulong)get_local_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_global_offset_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_offset(1) + (ulong)get_global_offset(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_local_id_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_local_id(1) + (ulong)get_local_id(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_group_id_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_group_id(1) + (ulong)get_group_id(0);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_id(1) + (ulong)get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_global_size_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_global_size(1) + (ulong)get_global_size(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_num_groups_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)get_num_groups(1) + (ulong)get_num_groups(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_get_work_dim_8_8(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)get_work_dim()) + (ulong)get_local_id(1);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)x + (ulong)get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)x + (ulong)get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)x + (ulong)get_local_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)x + (ulong)2;
    data[(get_global_id(1) * 8) / 8] = (ulong)x + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)x + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_global_id_x(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)((ulong)get_global_offset(0) + (ulong)x) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)x + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)x + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)get_global_offset(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_global_offset(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_global_offset(2);
}
...
void add_long_get_local_size_get_global_offset(int x, __global ulong *data)
{
    ...
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_offset(1) + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_offset(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_global_id_get_global_offset(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_global_id(0) + (ulong)get_global_offset(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_id(1) + (ulong)get_global_offset(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_id(2) + (ulong)get_global_offset(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)get_group_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_group_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_group_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_local_size_get_local_id(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)2;
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_global_id_get_local_id(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_local_id(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void add_long_get_global_size_get_local_id(__global long *data, int x)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)get_global_size(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_global_size(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_global_size(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_num_groups_get_local_id(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)get_num_groups(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_num_groups(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_num_groups(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_group_id(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_group_id(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_group_id(2) + (ulong)get_local_id(2);
}
...
void add_long_get_local_size_get_group_id(int x, __global ulong *data)
{
    ...
    data[(get_global_id(1) * 8) / 8] = (ulong)get_group_id(1) + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_group_id(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_global_id_get_group_id(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_group_id(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_group_id(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_group_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) + (ulong)x;
    data[(get_global_id(1) * 8) / 8] = (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) + (ulong)x;
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) + (ulong)get_global_offset(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) + (ulong)get_global_offset(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_id(2) + (ulong)get_global_offset(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(0) + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_local_id(1) + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_local_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_group_id(0) + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_group_id(1) + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_group_id(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) + (ulong)2;
    data[(get_global_id(1) * 8) / 8] = (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_id(2) + (ulong)4;
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_global_id(0) + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_id(1) + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_id(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void add_long_get_global_size_get_global_id(__global long *data, int x)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_size(0) + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_size(1) + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_size(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_num_groups_get_global_id(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_num_groups(0) + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_num_groups(1) + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_num_groups(2) + (ulong)get_global_id(2);
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_work_dim_get_global_id(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_work_dim() + (ulong)((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_work_dim() + (ulong)((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_size(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_size(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_size(2) + (ulong)get_local_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_size(0) + (ulong)2;
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_size(1) + (ulong)2;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_size(2) + (ulong)4;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void add_long_get_global_id_get_global_size(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_global_size(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_global_size(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_global_size(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_num_groups(0) + (ulong)get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_num_groups(1) + (ulong)get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_num_groups(2) + (ulong)get_local_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)get_num_groups(0) + (ulong)get_global_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_num_groups(1) + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_num_groups(2) + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_work_dim() + (ulong)x;
    data[(get_global_id(1) * 8) / 8] = (ulong)get_work_dim() + (ulong)x;
    data[(get_global_id(2) * 8) / 8] = (ulong)get_work_dim() + (ulong)x;
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_local_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (ulong)((ulong)get_global_offset(0) + (ulong)get_work_dim()) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_global_id(1);
    data[(get_global_id(2) * 8) / 8] = (ulong)get_work_dim() + (ulong)get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)x) + (ulong)get_local_id(1);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_global_offset_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_offset(1) + (ulong)get_global_offset(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_local_id_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_local_id(1) + (ulong)get_local_id(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_group_id_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_group_id(1) + (ulong)get_group_id(0);
}
...
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_id(1) + (ulong)get_global_id(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_global_size_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_global_size(1) + (ulong)get_global_size(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_num_groups_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)get_num_groups(1) + (ulong)get_num_groups(0);
}

__kernel __attribute__((reqd_work_group_size(8, 8, 1)))
void add_long_get_work_dim_8_8(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)get_work_dim()) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)((ulong)get_global_offset(0) + (ulong)x) + (ulong)(get_global_id(0) - get_global_offset(0));
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)((ulong)get_global_offset(0) + (ulong)get_global_offset(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_local_id(0) + (ulong)get_global_id(0);
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)((ulong)get_global_offset(0) + (ulong)get_group_id(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)((ulong)get_global_offset(0) + (ulong)get_global_size(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = (ulong)get_global_size(1) + (ulong)get_global_id(1);
    data[get_global_id(2)] = (ulong)get_global_size(2) + (ulong)get_global_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)get_work_dim() + (ulong)x;
    data[get_global_id(1)] = (ulong)get_work_dim() + (ulong)x;
    data[get_global_id(2)] = (ulong)get_work_dim() + (ulong)x;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)((ulong)get_global_offset(0) + (ulong)get_work_dim()) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = (ulong)get_work_dim() + (ulong)get_global_id(1);
    data[get_global_id(2)] = (ulong)get_work_dim() + (ulong)get_global_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)x) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0)] = (ulong)((ulong)((ulong)(get_group_id(1) * 8) + (ulong)get_global_offset(1)) + (ulong)get_work_dim()) + (ulong)get_local_id(1);
}
