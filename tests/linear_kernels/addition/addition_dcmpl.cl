...
{
    data[get_global_id(0)] = (uint)x + get_local_id(0);
    data[get_global_id(1)] = (uint)x + get_local_id(1);
    data[get_global_id(2)] = (uint)x + get_local_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_offset(0) + (uint)x + get_global_id(0) - get_global_offset(0);
...
{
    data[get_global_id(0)] = 333;
    data[get_global_id(1)] = 333;
    data[get_global_id(2)] = 333;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = 333;
    data[get_global_id(1)] = 333;
    data[get_global_id(2)] = 333;
}
...
{
    data[get_global_id(0)] = get_work_dim() + (uint)x;
    data[get_global_id(1)] = get_work_dim() + (uint)x;
    data[get_global_id(2)] = get_work_dim() + (uint)x;
}
...
{
    data[get_global_id(0)] = get_group_id(1) * 8 + get_global_offset(1) + (uint)x + get_local_id(1);
}
...
{
    data[get_global_id(0)] = get_group_id(1) * 8 + get_global_offset(1) + get_work_dim() + get_local_id(1);
}
...
{
    data[get_global_id(0)] = get_local_id(0) + (uint)x;
    data[get_global_id(1)] = get_local_id(1) + (uint)x;
    data[get_global_id(2)] = get_local_id(2) + (uint)x;
}
...
{
    data[get_global_id(0)] = get_global_id(0) - get_global_offset(0) + get_global_offset(0) + (uint)x;
    data[get_global_id(1)] = get_global_id(1) - get_global_offset(1) + get_global_offset(1) + (uint)x;
...
{
    data[get_global_id(0)] = get_global_id(0) - get_global_offset(0) + get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_global_id(1) - get_global_offset(1) + get_global_offset(1) + get_global_offset(1);
    data[get_global_id(2)] = get_global_id(2) + get_global_offset(2);
}
...
{
    data[get_global_id(0)] = get_local_id(0) + get_global_id(0) - get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_local_id(1) + get_global_id(1) - get_global_offset(1) + get_global_offset(1);
    data[get_global_id(2)] = get_local_id(2) + get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_group_id(0) + get_global_id(0) - get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_group_id(1) + get_global_id(1) - get_global_offset(1) + get_global_offset(1);
    data[get_global_id(2)] = get_group_id(2) + get_global_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) + get_global_id(0) - get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_global_id(1) + get_global_id(1) - get_global_offset(1) + get_global_offset(1);
...
{
    data[get_global_id(0)] = get_global_size(0) + get_global_id(0) - get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_global_size(1) + get_global_id(1) - get_global_offset(1) + get_global_offset(1);
    data[get_global_id(2)] = get_global_size(2) + get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_work_dim() + get_global_id(0) - get_global_offset(0) + get_global_offset(0);
    data[get_global_id(1)] = get_work_dim() + get_global_id(1) - get_global_offset(1) + get_global_offset(1);
    data[get_global_id(2)] = get_work_dim() + get_global_id(2);
}
