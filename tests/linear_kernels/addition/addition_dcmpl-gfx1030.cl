...
{
    data[get_global_id(0)] = (ulong)get_global_offset(0) + x;
    data[get_global_id(1)] = (ulong)get_global_offset(1) + x;
    data[get_global_id(2)] = (ulong)get_global_offset(2) + x;
}
...
{
    data[get_global_id(0)] = (ulong)get_group_id(0) + x;
    data[get_global_id(1)] = (ulong)get_group_id(1) + x;
    data[get_global_id(2)] = (ulong)get_group_id(2) + x;
}
...
{
    data[get_global_id(0)] = (ulong)get_global_size(0) + x;
    data[get_global_id(1)] = (ulong)get_global_size(1) + x;
    data[get_global_id(2)] = (ulong)get_global_size(2) + x;
}
...
{
    data[get_global_id(0)] = 2 + (ulong)get_work_dim();
    data[get_global_id(1)] = 2 + (ulong)get_work_dim();
    data[get_global_id(2)] = 4 + (ulong)get_work_dim();
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = ((ulong)get_global_offset(0) + (ulong)get_num_groups(0)) + (ulong)(get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = (ulong)get_num_groups(1) + get_global_id(1);
    data[get_global_id(2)] = (ulong)get_num_groups(2) + get_global_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)((ulong)get_global_offset(1) + x) + (ulong)(get_group_id(1) * 8) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0)] = (ulong)get_global_id(1) + get_global_id(0);
}
...
{
    data[get_global_id(0)] = ((ulong)get_global_offset(1) + (ulong)get_work_dim()) + (ulong)(get_group_id(1) * 8) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) + (ulong)get_local_id(0);
    data[get_global_id(1)] = get_global_id(1) + (ulong)get_local_id(1);
    data[get_global_id(2)] = get_global_id(2) + (ulong)get_local_id(2);
}
...
void add_long_get_work_dim_get_local_size(int x, __global ulong *data)
{
    ...
    data[get_global_id(2)] = (ulong)get_work_dim() + 4;
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void add_long_x_get_global_id(__global long *data, int x)
{
    data[get_global_id(0)] = get_global_id(0) + (ulong)x;
...
{
    data[get_global_id(0)] = get_global_id(0) + (ulong)get_local_id(0);
    data[get_global_id(1)] = get_global_id(1) + (ulong)get_local_id(1);
    data[get_global_id(2)] = get_global_id(2) + (ulong)get_local_id(2);
}
...
{
    data[get_global_id(0)] = get_global_id(0) + (ulong)get_group_id(0);
    data[get_global_id(1)] = get_global_id(1) + (ulong)get_group_id(1);
    data[get_global_id(2)] = get_global_id(2) + (ulong)get_group_id(2);
}
...
{
    data[get_global_id(0)] = get_global_id(0) + (ulong)get_global_size(0);
...
{
    data[get_global_id(0)] = get_global_id(0) + (ulong)get_work_dim();
    data[get_global_id(1)] = get_global_id(1) + (ulong)get_work_dim();
    data[get_global_id(2)] = get_global_id(2) + (ulong)get_work_dim();
}
...
{
    data[get_global_id(0)] = get_num_groups(0) + (ulong)get_work_dim();
    data[get_global_id(1)] = get_num_groups(1) + (ulong)get_work_dim();
    data[get_global_id(2)] = get_num_groups(2) + (ulong)get_work_dim();
}
...
{
    data[get_global_id(0)] = x + (ulong)get_group_id(0);
    data[get_global_id(1)] = x + (ulong)get_group_id(1);
    data[get_global_id(2)] = x + (ulong)get_group_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)get_global_id(0) + 2;
    data[get_global_id(1)] = (ulong)get_global_id(1) + 2;
    data[get_global_id(2)] = (ulong)get_global_id(2) + 4;
}
...
{
    data[get_global_id(0)] = get_num_groups(1) + (ulong)get_num_groups(0);
}
