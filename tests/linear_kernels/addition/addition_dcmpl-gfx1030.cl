...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)(get_global_offset(0) * 2) + (get_global_id(0) - get_global_offset(0));
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) + get_work_dim();
    data[get_global_id(1)] = get_work_dim() + get_global_id(1);
    data[get_global_id(2)] = get_work_dim() + get_global_id(2);
}
...
{
    data[get_global_id(0)] = (ulong)((ulong)get_global_offset(1) + x) + (get_group_id(1) * 8) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0)] = ((ulong)get_global_offset(1) + get_work_dim()) + (get_group_id(1) * 8) + (ulong)get_local_id(1);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (ulong)get_global_id(0) + get_work_dim();
    data[get_global_id(1)] = get_work_dim() + (ulong)get_global_id(1);
    data[get_global_id(2)] = get_work_dim() + (ulong)get_global_id(2);
}
