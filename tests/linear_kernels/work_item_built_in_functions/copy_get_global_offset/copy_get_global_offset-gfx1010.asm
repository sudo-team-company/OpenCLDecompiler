/* Disassembling 'linear_kernels/work_item_built_in_functions/copy_get_global_offset/copy_get_global_offset-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
.kernel copy_get_global_offset
    ...
    .control_directive
        .fill 128, 1, 0x00
    .config
        .md_symname "copy_get_global_offset@kd"
...
/*000000000128*/ s_lshl_b32      s6, s7, 4
/*00000000012c*/ s_lshl_b32      s7, s8, 1
