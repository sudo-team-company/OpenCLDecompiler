// llvm-mc -triple=amdgcn--amdhsa -mcpu=gfx1103 -mattr=+wavefrontsize32,+wavefrontsize64
	...
	.long 0xe0                                                 // 000000000720: 000000E0
	.long 0                                                    // 000000000724: 00000000
	.long 0x18                                                 // 000000000728: 00000018
	...
	.long 0x2c0000                                             // 000000000750: 002C0000
	.long 0x20000                                              // 000000000754: 00020000
	.long 0x1                                                  // 000000000758: 00000001
	.long 0x4e0980d4                                           // 00000000075C: 4E0980D4
	.long 0xc40f1e93                                           // 000000000760: C40F1E93
	...
	.type	copy_get_global_offset.kd,@object
copy_get_global_offset.kd:
	...
	.p2align	8
	.type	copy_get_global_offset,@function
	.size	copy_get_global_offset, copy_get_global_offset_symend-copy_get_global_offset
copy_get_global_offset:
	...
	v_dual_mov_b32 v2, 0 :: v_dual_and_b32 v1, 0x3ff, v0       // 00000000181C: CA240080 020000FF 000003FF
	s_lshl_b32 s2, s2, 1                                       // 000000001828: 84028102
	...
	v_add3_u32 v1, s8, s2, v1                                  // 000000001844: D6550001 04040408
	s_lshl_b32 s2, s3, 4                                       // 00000000184C: 84028403
	v_dual_mov_b32 v7, s8 :: v_dual_mov_b32 v8, s10            // 000000001850: CA100008 0708000A
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000001858: BF8700B2
	v_lshlrev_b64 v[3:4], 2, v[1:2]                            // 00000000185C: D73C0003 00020282
	v_add3_u32 v1, s10, s2, v5                                 // 000000001864: D6550001 0414040A
	s_lshl_b32 s2, s4, 1                                       // 00000000186C: 84028104
	v_lshlrev_b64 v[5:6], 2, v[1:2]                            // 000000001870: D73C0005 00020282
	v_add3_u32 v1, s5, s2, v0                                  // 000000001878: D6550001 04000405
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_3)// 000000001880: BF8701A4
	v_add_co_u32 v3, vcc_lo, s0, v3                            // 000000001884: D7006A03 00020600
	v_add_co_ci_u32_e32 v4, vcc_lo, s1, v4, vcc_lo             // 00000000188C: 40080801
	v_lshlrev_b64 v[0:1], 2, v[1:2]                            // 000000001890: D73C0000 00020282
	v_add_co_u32 v5, vcc_lo, s0, v5                            // 000000001898: D7006A05 00020A00
	v_add_co_ci_u32_e32 v6, vcc_lo, s1, v6, vcc_lo             // 0000000018A0: 400C0C01
	v_mov_b32_e32 v2, s5                                       // 0000000018A4: 7E040205
	s_delay_alu instid0(VALU_DEP_4)                            // 0000000018A8: BF870004
	v_add_co_u32 v0, vcc_lo, s0, v0                            // 0000000018AC: D7006A00 00020000
	v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo             // 0000000018B4: 40020201
	s_clause 0x2                                               // 0000000018B8: BF850002
	global_store_b32 v[3:4], v7, off                           // 0000000018BC: DC6A0000 007C0703
	global_store_b32 v[5:6], v8, off                           // 0000000018C4: DC6A0000 007C0805
	global_store_b32 v[0:1], v2, off                           // 0000000018CC: DC6A0000 007C0200
	s_nop 0                                                    // 0000000018D4: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 0000000018D8: BFB60003
	s_endpgm                                                   // 0000000018DC: BFB00000
copy_get_global_offset_symend:
...
_DYNAMIC:
	...
	.long 0x6f8                                                // 000000002A88: 000006F8
...
amdhsa.kernels:
  - .args:
    ...
    .sgpr_count:     0x24
    .sgpr_spill_count: 0
    .symbol:         copy_get_global_offset.kd
