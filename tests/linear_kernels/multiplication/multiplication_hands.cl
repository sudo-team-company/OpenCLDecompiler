...
{
    data[(get_global_id(0) * 4) / 4] = get_global_offset(0) * get_global_offset(0);
    data[(get_global_id(1) * 4) / 4] = get_global_offset(1) * get_global_offset(1);
    data[(get_global_id(2) * 4) / 4] = get_global_offset(2) * get_global_offset(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = (int)get_local_id(0) * (int)get_local_id(0);
    data[(get_global_id(1) * 4) / 4] = (int)get_local_id(1) * (int)get_local_id(1);
    data[(get_global_id(2) * 4) / 4] = (int)get_local_id(2) * (int)get_local_id(2);
}
...
void mul_get_local_size_get_local_id(int x, __global uint *data)
{
    ...
    data[(get_global_id(2) * 4) / 4] = get_local_id(2) * 4;
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_group_id(0) * get_group_id(0);
    data[(get_global_id(1) * 4) / 4] = get_group_id(1) * get_group_id(1);
    data[(get_global_id(2) * 4) / 4] = get_group_id(2) * get_group_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = get_group_id(0) * get_global_id(0);
...
{
    data[(get_global_id(0) * 4) / 4] = get_local_id(0) * 8;
    data[(get_global_id(1) * 4) / 4] = get_local_id(1) * 4;
...
void mul_get_global_id_get_local_size(int x, __global uint *data)
{
    ...
    data[(get_global_id(2) * 4) / 4] = get_global_id(2) * 4;
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(0) * x;
    data[(get_global_id(1) * 4) / 4] = get_global_id(1) * x;
    data[(get_global_id(2) * 4) / 4] = get_global_id(2) * x;
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(0) * get_global_offset(0);
    data[(get_global_id(1) * 4) / 4] = get_global_id(1) * get_global_offset(1);
    data[(get_global_id(2) * 4) / 4] = get_global_id(2) * get_global_offset(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = get_global_id(0) * get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = get_global_id(1) * get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = get_global_id(2) * get_global_id(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = get_global_size(0) * get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = get_global_size(1) * get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = get_global_size(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_global_size(0) * get_global_size(0);
    data[(get_global_id(1) * 4) / 4] = get_global_size(1) * get_global_size(1);
    data[(get_global_id(2) * 4) / 4] = get_global_size(2) * get_global_size(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = get_num_groups(0) * get_global_id(0);
    data[(get_global_id(1) * 4) / 4] = get_num_groups(1) * get_global_id(1);
    data[(get_global_id(2) * 4) / 4] = get_num_groups(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_num_groups(0) * get_num_groups(0);
    data[(get_global_id(1) * 4) / 4] = get_num_groups(1) * get_num_groups(1);
    data[(get_global_id(2) * 4) / 4] = get_num_groups(2) * get_num_groups(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 4) / 4] = get_work_dim() * get_global_id(0);
...
{
    data[(get_global_id(0) * 4) / 4] = get_work_dim() * get_work_dim();
    data[(get_global_id(1) * 4) / 4] = get_work_dim() * get_work_dim();
    data[(get_global_id(2) * 4) / 4] = get_work_dim() * get_work_dim();
}
...
{
    data[(get_global_id(0) * 4) / 4] = 0x1000;
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void mul_get_global_id_64(int x, __global uint *data)
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(0) * get_global_id(0);
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(1) * x;
}
...
{
    data[(get_global_id(0) * 4) / 4] = (int)get_local_id(1) * (int)get_local_id(0);
}
...
{
    data[(get_global_id(0) * 4) / 4] = get_global_id(1) * get_work_dim();
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void mul_long_x_x(__global long *data, int x)
{
    data[(get_global_id(0) * 8) / 8] = x * x;
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_local_id(0) * get_local_id(0);
    data[(get_global_id(1) * 8) / 8] = get_local_id(1) * get_local_id(1);
    data[(get_global_id(2) * 8) / 8] = get_local_id(2) * get_local_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_group_id(0) * get_group_id(0);
    data[(get_global_id(1) * 8) / 8] = get_group_id(1) * get_group_id(1);
    data[(get_global_id(2) * 8) / 8] = get_group_id(2) * get_group_id(2);
}
...
void mul_long_get_local_size_get_local_size(int x, __global ulong *data)
{
    ...
    data[(get_global_id(2) * 8) / 8] = 16 * 1;
}

__kernel __attribute__((reqd_work_group_size(2, 2, 4)))
void mul_long_get_global_id_get_local_size(int x, __global ulong *data)
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = (((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * 2) * 2;
...
{
    data[(get_global_id(0) * 8) / 8] = ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * x;
    data[(get_global_id(1) * 8) / 8] = ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) * x;
    data[(get_global_id(2) * 8) / 8] = get_global_id(2) * x;
}
...
{
    data[(get_global_id(0) * 8) / 8] = ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * get_global_offset(0);
    data[(get_global_id(1) * 8) / 8] = ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) * get_global_offset(1);
    data[(get_global_id(2) * 8) / 8] = get_global_id(2) * get_global_offset(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_local_id(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_local_id(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = get_local_id(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_group_id(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_group_id(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[(get_global_id(2) * 8) / 8] = get_group_id(2) * get_global_id(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * 2;
    data[(get_global_id(1) * 8) / 8] = ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) * 2;
    data[(get_global_id(2) * 8) / 8] = get_global_id(2) * 4;
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = get_global_id(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_global_id(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
...
{
    data[(get_global_id(0) * 8) / 8] = get_global_size(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_global_size(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
...
{
    data[(get_global_id(0) * 8) / 8] = get_num_groups(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_num_groups(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
...
{
    data[(get_global_id(0) * 8) / 8] = get_work_dim() * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[(get_global_id(1) * 8) / 8] = get_work_dim() * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
...
{
    data[(get_global_id(0) * 8) / 8] = get_global_size(0) * get_global_size(0);
    data[(get_global_id(1) * 8) / 8] = get_global_size(1) * get_global_size(1);
    data[(get_global_id(2) * 8) / 8] = get_global_size(2) * get_global_size(2);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_num_groups(0) * get_num_groups(0);
    data[(get_global_id(1) * 8) / 8] = get_num_groups(1) * get_num_groups(1);
    data[(get_global_id(2) * 8) / 8] = get_num_groups(2) * get_num_groups(2);
}
...
{
    data[((get_global_id(0) - get_global_offset(0)) * 8) / 8] = get_work_dim() * get_global_id(0);
...
{
    data[(get_global_id(0) * 8) / 8] = get_work_dim() * get_work_dim();
    data[(get_global_id(1) * 8) / 8] = get_work_dim() * get_work_dim();
    data[(get_global_id(2) * 8) / 8] = get_work_dim() * get_work_dim();
}
...
{
    data[(get_global_id(0) * 8) / 8] = (int)get_local_id(0) * (int)get_local_id(0);
}
...
{
    data[(get_global_id(0) * 8) / 8] = 1 * 4096;
}

__kernel __attribute__((reqd_work_group_size(64, 1, 1)))
void mul_long_get_global_id_64(int x, __global ulong *data)
{
    data[(get_global_id(0) * 8) / 8] = get_global_id(0) * get_global_id(0);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_global_id(1) * x;
}
...
{
    data[(get_global_id(0) * 8) / 8] = (int)get_local_id(1) * (int)get_local_id(0);
}
...
{
    data[(get_global_id(0) * 8) / 8] = get_global_id(1) * get_work_dim();
}
