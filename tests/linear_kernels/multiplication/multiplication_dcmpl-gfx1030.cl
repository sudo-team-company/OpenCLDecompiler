...
void mul_get_global_id_get_global_offset(int x, __global uint *data)
{
    ...
    data[get_global_id(1) - get_global_offset(1)] = (get_global_id(1) - get_global_offset(1)) * get_global_offset(1);
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * get_global_offset(2);
}
...
{
    data[get_global_id(0)] = x * (int)16;
    data[get_global_id(1)] = x * (int)2;
    data[get_global_id(2)] = x * (int)2;
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void mul_get_global_offset_get_local_size(int x, __global int *data)
{
    data[get_global_id(0)] = get_global_offset(0) * (int)2;
    data[get_global_id(1)] = get_global_offset(1) * (int)16;
    data[get_global_id(2)] = get_global_offset(2) * (int)2;
}

__kernel __attribute__((reqd_work_group_size(8, 4, 2)))
void mul_get_local_id_get_local_size(int x, __global int *data)
{
    data[get_global_id(0)] = get_local_id(0) * (int)8;
    data[get_global_id(1)] = get_local_id(1) * (int)4;
    data[get_global_id(2)] = get_local_id(2) * (int)2;
}
...
void mul_get_global_id_get_local_size(int x, __global uint *data)
{
    ...
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * 4;
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void mul_get_global_size_get_local_size(__global int *data, int x)
{
    data[get_global_id(0)] = get_global_size(0) * (int)16;
    data[get_global_id(1)] = get_global_size(1) * (int)2;
    data[get_global_id(2)] = get_global_size(2) * (int)2;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (get_global_id(0) - get_global_offset(0)) * x;
    data[get_global_id(1) - get_global_offset(1)] = (get_global_id(1) - get_global_offset(1)) * x;
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * x;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (get_global_id(0) - get_global_offset(0)) * 2;
    data[get_global_id(1) - get_global_offset(1)] = (get_global_id(1) - get_global_offset(1)) * 2;
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * 4;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (get_global_id(0) - get_global_offset(0)) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1) - get_global_offset(1)] = (get_global_id(1) - get_global_offset(1)) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * (get_global_id(2) - get_global_offset(2));
}
...
{
    data[get_global_id(0)] = (uint)x * (uint)x;
}
...
{
    data[get_global_id(0)] = get_global_id(1) * (uint)x;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(1) * (get_global_id(0) - get_global_offset(0));
}
...
{
    data[get_global_id(0)] = x * (long)16;
    data[get_global_id(1)] = x * (long)2;
    data[get_global_id(2)] = x * (long)2;
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void mul_long_get_global_offset_get_local_size(int x, __global long *data)
{
    data[get_global_id(0)] = get_global_offset(0) * (long)2;
    data[get_global_id(1)] = get_global_offset(1) * (long)16;
    data[get_global_id(2)] = get_global_offset(2) * (long)2;
}

__kernel __attribute__((reqd_work_group_size(8, 4, 2)))
void mul_long_get_local_id_get_local_size(int x, __global long *data)
{
    data[get_global_id(0)] = get_local_id(0) * (long)8;
    data[get_global_id(1)] = get_local_id(1) * (long)4;
    data[get_global_id(2)] = get_local_id(2) * (long)2;
}
...
{
    data[get_global_id(0)] = get_global_size(0) * (long)16;
    data[get_global_id(1)] = get_global_size(1) * (long)2;
    data[get_global_id(2)] = get_global_size(2) * (long)2;
}
...
{
    data[get_global_id(0)] = get_global_id(0) * get_local_id(0);
    data[get_global_id(1)] = get_global_id(1) * get_local_id(1);
    data[get_global_id(2)] = get_global_id(2) * get_local_id(2);
}
...
{
    data[get_global_id(0)] = get_global_id(0) * get_group_id(0);
    data[get_global_id(1)] = get_global_id(1) * get_group_id(1);
    data[get_global_id(2)] = get_global_id(2) * get_group_id(2);
}
...
{
    data[get_global_id(0)] = get_global_id(0) * get_global_size(0);
...
{
    data[get_global_id(0)] = get_global_id(0) * get_num_groups(0);
...
{
    data[get_global_id(0)] = get_global_id(0) * get_work_dim();
...
{
    data[get_global_id(0)] = (ulong)x * (ulong)x;
}
...
{
    data[get_global_id(0)] = get_global_id(1) * (ulong)x;
}
...
{
    data[get_global_id(0)] = (char)x * (char)x;
}
...
void mul_char_get_local_size_x(int x, __global uchar *data)
{
    ...
    data[get_global_id(1)] = (uchar)x * (uchar)2;
    data[get_global_id(2)] = (uchar)x * (uchar)4;
}
...
void mul_char_get_local_size_get_global_offset(int x, __global uchar *data)
{
    ...
    data[get_global_id(1)] = get_global_offset(1) * (uchar)2;
    data[get_global_id(2)] = get_global_offset(2) * (uchar)4;
}
...
void mul_char_get_local_size_get_local_id(int x, __global uchar *data)
{
    ...
    data[get_global_id(1)] = get_local_id(1) * (uchar)2;
    data[get_global_id(2)] = get_local_id(2) * (uchar)4;
}
...
{
    data[get_global_id(0)] = (char)x * (char)16;
    data[get_global_id(1)] = (char)x * (char)2;
    data[get_global_id(2)] = (char)x * (char)2;
}

__kernel __attribute__((reqd_work_group_size(2, 16, 2)))
void mul_char_get_global_offset_get_local_size(int x, __global char *data)
{
    data[get_global_id(0)] = get_global_offset(0) * (char)2;
    data[get_global_id(1)] = get_global_offset(1) * (char)16;
    data[get_global_id(2)] = get_global_offset(2) * (char)2;
}

__kernel __attribute__((reqd_work_group_size(8, 4, 2)))
void mul_char_get_local_id_get_local_size(int x, __global char *data)
{
    data[get_global_id(0)] = get_local_id(0) * (char)8;
    data[get_global_id(1)] = get_local_id(1) * (char)4;
    data[get_global_id(2)] = get_local_id(2) * (char)2;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = (get_global_id(0) - get_global_offset(0)) * (uchar)2;
...
{
    data[get_global_id(0)] = get_global_size(0) * (char)16;
    data[get_global_id(1)] = get_global_size(1) * (char)2;
    data[get_global_id(2)] = get_global_size(2) * (char)2;
}
...
void mul_char_get_num_groups_get_local_size(int x, __global uchar *data)
{
    ...
    data[get_global_id(2)] = get_num_groups(2) * (uchar)4;
}
...
void mul_char_get_work_dim_get_local_size(int x, __global uchar *data)
{
    ...
    data[get_global_id(2)] = get_work_dim() * (uchar)4;
}

__kernel __attribute__((reqd_work_group_size(16, 2, 2)))
void mul_char_x_get_global_id(__global char *data, int x)
{
    data[get_global_id(0) - get_global_offset(0)] = (get_global_id(0) - get_global_offset(0)) * (char)x;
    data[get_global_id(1) - get_global_offset(1)] = (get_global_id(1) - get_global_offset(1)) * (char)x;
    data[get_global_id(2) - get_global_offset(2)] = (get_global_id(2) - get_global_offset(2)) * (char)x;
}
...
void mul_char_get_local_size_get_global_size(int x, __global uchar *data)
{
    ...
    data[get_global_id(1)] = get_global_size(1) * (uchar)2;
    data[get_global_id(2)] = get_global_size(2) * (uchar)4;
}
...
{
    data[get_global_id(0)] = (uchar)x * (uchar)x;
}
...
{
    data[get_global_id(0)] = get_global_id(1) * (uchar)x;
}
