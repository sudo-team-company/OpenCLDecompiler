...
{
    data[get_global_id(0)] = ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * x;
    data[get_global_id(1)] = ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) * x;
    data[get_global_id(2)] = get_global_id(2) * x;
}
...
{
    data[get_global_id(0)] = ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0)) * get_global_offset(0);
    data[get_global_id(1)] = ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1)) * get_global_offset(1);
    data[get_global_id(2)] = get_global_id(2) * get_global_offset(2);
}
...
{
    data[get_global_id(0)] = get_local_id(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[get_global_id(1)] = get_local_id(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[get_global_id(2)] = get_local_id(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_group_id(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[get_global_id(1)] = get_group_id(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[get_global_id(2)] = get_group_id(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_global_size(0) * ((ulong)(get_global_id(0) - get_global_offset(0)) + (ulong)get_global_offset(0));
    data[get_global_id(1)] = get_global_size(1) * ((ulong)(get_global_id(1) - get_global_offset(1)) + (ulong)get_global_offset(1));
    data[get_global_id(2)] = get_global_size(2) * get_global_id(2);
}
