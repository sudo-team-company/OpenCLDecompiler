...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) * (uint)x;
...
{
    data[get_global_id(0)] = (get_global_id(0) - get_global_offset(0)) * x;
    data[get_global_id(1)] = (get_global_id(1) - get_global_offset(1)) * x;
    data[get_global_id(2)] = get_global_id(2) * x;
}
...
{
    data[get_global_id(0)] = (get_global_id(0) - get_global_offset(0)) * get_global_offset(0);
    data[get_global_id(1)] = (get_global_id(1) - get_global_offset(1)) * get_global_offset(1);
    data[get_global_id(2)] = get_global_id(2) * get_global_offset(2);
}
...
{
    data[get_global_id(0)] = get_local_id(0) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_local_id(1) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_local_id(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_group_id(0) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_group_id(1) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_group_id(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = (get_global_id(0) - get_global_offset(0)) * 2;
    data[get_global_id(1)] = (get_global_id(1) - get_global_offset(1)) * 2;
    data[get_global_id(2)] = get_global_id(2) * 4;
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_global_id(1) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_global_id(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_global_size(0) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_global_size(1) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_global_size(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_num_groups(0) * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_num_groups(1) * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_num_groups(2) * get_global_id(2);
}
...
{
    data[get_global_id(0)] = get_work_dim() * (get_global_id(0) - get_global_offset(0));
    data[get_global_id(1)] = get_work_dim() * (get_global_id(1) - get_global_offset(1));
    data[get_global_id(2)] = get_work_dim() * get_global_id(2);
}
...
{
    data[get_global_id(0) - get_global_offset(0)] = get_global_id(0) * (uchar)x;
    data[get_global_id(1)] = get_global_id(1) * (uchar)x;
    data[get_global_id(2)] = get_global_id(2) * (uchar)x;
}
...
{
    data[get_global_id(0)] = get_global_id(0) * (char)x;
    data[get_global_id(1)] = get_global_id(1) * (char)x;
    data[get_global_id(2)] = get_global_id(2) * (char)x;
}
