/* Disassembling 'different_types\char_short_test\char_short_test.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*000000000034*/ s_bfe_i32       s0, s1, 0x80000
...
/*00000000004c*/ s_bfe_i32       s0, s1, 0x100010
