...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("branching_kernels", "if_1", None, "amd_gcn", "clrxdisasm"),
        pytest.param("branching_kernels", "if_1", None, "gfx1010", "clrxdisasm"),
        pytest.param("branching_kernels", "if_1", None, "gfx1030", "clrxdisasm"),
        pytest.param("branching_kernels", "if_2", None, "amd_gcn", "clrxdisasm"),
        pytest.param("branching_kernels", "if_2", None, "gfx1010", "clrxdisasm"),
        pytest.param("branching_kernels", "if_2", None, "gfx1030", "clrxdisasm"),
        ...
        pytest.param("global_data_usage", "int_kernels", None, "amd_gcn", "clrxdisasm"),
        pytest.param("global_data_usage", "long_kernels", None, "amd_gcn", "clrxdisasm"),
        pytest.param("global_data_usage", "mixed_kernels", None, "amd_gcn", "clrxdisasm"),
        pytest.param("global_data_usage", "float_kernels", None, "amd_gcn", "clrxdisasm"),
        pytest.param("global_data_usage", "double_kernels", None, "amd_gcn", "clrxdisasm"),
