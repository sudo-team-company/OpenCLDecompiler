/* Disassembling 'loops_kernels\loop_with_break_kernels\loop_with_break_kernels-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
/*00000000011c*/ s_cbranch_scc1  .L404_0
/*000000000120*/ s_mov_b64       s[10:11], s[8:9]
/*000000000124*/ s_branch        .L328_0
/*000000000128*/ s_nop           0x0
/*00000000012c*/ s_nop           0x0
/*000000000130*/ s_nop           0x0
/*000000000134*/ s_nop           0x0
/*000000000138*/ s_nop           0x0
/*00000000013c*/ s_nop           0x0
.L320_0:
/*000000000140*/ s_andn2_b32     vcc_lo, exec_lo, s7
/*000000000144*/ s_cbranch_vccz  .L404_0
.L328_0:
/*000000000148*/ s_load_dword    s3, s[10:11], 0x0
/*000000000150*/ v_mov_b32       v1, s10
/*000000000154*/ v_mov_b32       v2, s11
/*000000000158*/ s_mov_b32       s7, -1
/*00000000015c*/ s_waitcnt       lgkmcnt(0)
/*000000000160*/ s_add_i32       s3, s3, s1
/*000000000164*/ v_mov_b32       v3, s3
/*000000000168*/ s_cmp_eq_u32    s3, 0
/*00000000016c*/ global_store_dword v[1:2], v3, off
/*000000000174*/ s_cbranch_scc1  .L320_0
/*000000000178*/ s_add_i32       s2, s2, -1
/*00000000017c*/ s_add_u32       s10, s10, 4
/*000000000180*/ v_cmp_eq_u32    s[7:8], s2, 0
/*000000000188*/ s_mul_i32       s1, s3, s0
/*00000000018c*/ s_addc_u32      s11, s11, 0
/*000000000190*/ s_branch        .L320_0
.L404_0:
/*000000000194*/ s_load_dwordx2  s[2:3], s[4:5], 0x18
/*00000000019c*/ v_lshl_or_b32   v0, s6, 6, v0
/*0000000001a4*/ s_waitcnt       lgkmcnt(0)
/*0000000001a8*/ v_add_co_u32    v0, s[1:2], s2, v0
/*0000000001b0*/ v_add_co_ci_u32 v1, s[1:2], s3, 0, s[1:2]
/*0000000001b8*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*0000000001c0*/ v_add_co_u32    v0, vcc, s8, v0
/*0000000001c8*/ v_add_co_ci_u32 v1, vcc, s9, v1, vcc
/*0000000001cc*/ global_load_dword v2, v[0:1], off
/*0000000001d4*/ s_waitcnt       vmcnt(0)
/*0000000001d8*/ v_add_nc_u32    v2, s0, v2
/*0000000001dc*/ global_store_dword v[0:1], v2, off
/*0000000001e4*/ s_endpgm
