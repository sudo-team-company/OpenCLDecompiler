/* Disassembling 'loops_kernels\simple_loop_1_kernels\simple_loop_1_kernels-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
.L384_0:
/*000000000180*/ v_lshlrev_b64   v[2:3], 2, v[0:1]
/*000000000188*/ v_add_nc_u32    v0, 1, v0
/*00000000018c*/ s_add_i32       s2, s2, -1
/*000000000190*/ s_cmp_eq_u32    s2, 0
/*000000000194*/ v_add_co_u32    v2, vcc, s4, v2
/*00000000019c*/ v_add_co_ci_u32 v3, vcc, s5, v3, vcc
/*0000000001a0*/ global_load_dword v4, v[2:3], off
/*0000000001a8*/ s_waitcnt       vmcnt(0)
/*0000000001ac*/ v_mul_lo_u32    v4, v4, s0
/*0000000001b4*/ v_add_nc_u32    v4, s1, v4
/*0000000001b8*/ global_store_dword v[2:3], v4, off
/*0000000001c0*/ s_cbranch_scc0  .L384_0
.L452_0:
