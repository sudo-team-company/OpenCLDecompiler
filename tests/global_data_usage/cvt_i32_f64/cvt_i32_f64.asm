/* Disassembling 'global_data_usage\cvt_i32_f64\cvt_i32_f64.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*00000000001c*/ v_lshlrev_b64   v[2:3], 3, v[0:1]
...
/*000000000064*/ v_addc_u32      v1, vcc, v4, v1, vcc
/*000000000068*/ s_waitcnt       vmcnt(0)
/*00000000006c*/ v_cvt_i32_f64   v2, v[2:3]
