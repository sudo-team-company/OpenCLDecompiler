...
some_array_test:
	...
	global_load_dword v8, v[8:9], off                          // 000000001984: DC308000 087D0008
	global_load_dwordx2 v[6:7], v[6:7], off                    // 00000000198C: DC348000 067D0006
	...
	global_store_dword v[2:3], v8, off                         // 0000000019CC: DC708000 007D0802
	s_waitcnt vmcnt(0)                                         // 0000000019D4: BF8C3F70
	global_store_dwordx2 v[0:1], v[6:7], off                   // 0000000019D8: DC748000 007D0600
