...
int_test:
	...
	v_add_co_u32 v4, vcc_lo, v8, s0                            // 000000001948: D70F6A04 00000108
	v_add_co_ci_u32_e32 v5, vcc_lo, s1, v9, vcc_lo             // 000000001950: 500A1201
	s_load_dwordx2 s[0:1], s[6:7], null                        // 000000001954: F4040003 FA000000
	s_clause 0x1                                               // 00000000195C: BFA10001
	global_load_dwordx4 v[0:3], v[4:5], off offset:16          // 000000001960: DC388010 007D0004
	global_load_dwordx4 v[4:7], v[4:5], off                    // 000000001968: DC388000 047D0004
