// llvm-mc -triple=amdgcn--amdhsa -mcpu=gfx1010 -mattr=+wavefrontsize32,+wavefrontsize64
	...
	.long 0x9c                                                 // 000000000738: 0000009C
...
float_test.kd:
	...
	.type	snd_arr,@object
snd_arr:
	.long 0x2                                                  // 000000000800: 00000002
	...
	.long 0x8                                                  // 000000000818: 00000008
	...
	.ascii "\n"                                                // 000000000828: 0A
	.byte 0                                                    // 000000000829: 00
	.short 0                                                   // 00000000082A: 0000
	.long 0                                                    // 00000000082C: 00000000
	.long 0xb                                                  // 000000000830: 0000000B
...
float_test:
	...
	v_cvt_f64_i32_e32 v[3:4], v3                               // 000000001978: 7E060903
	v_cvt_f64_u32_e32 v[5:6], v2                               // 00000000197C: 7E0A2D02
	v_ldexp_f64 v[3:4], v[3:4], 32                             // 000000001980: D5680003 00014103
	v_add_f64 v[2:3], v[3:4], v[5:6]                           // 000000001988: D5640002 00020B03
	global_store_dwordx2 v[0:1], v[2:3], off                   // 000000001990: DC748000 007D0200
