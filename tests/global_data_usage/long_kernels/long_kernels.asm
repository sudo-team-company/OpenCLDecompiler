...
.kernel long_test
    .config
        ...
        .arg i, "int", int
    .text
/*000000000000*/ s_load_dword    s8, s[4:5], 0x38
...
/*000000000024*/ s_lshl_b64      s[6:7], s[8:9], 3
...
/*000000000040*/ s_load_dwordx2  s[6:7], s[6:7], 0x0
/*000000000048*/ s_add_u32       s0, s1, s2
...
/*00000000006c*/ v_mov_b32       v2, s6
/*000000000070*/ v_mov_b32       v3, s7
/*000000000074*/ flat_store_dwordx2 v[0:1], v[2:3]
