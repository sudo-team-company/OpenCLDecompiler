// llvm-mc -triple=amdgcn--amdhsa -mcpu=gfx1030 -mattr=+wavefrontsize32,+wavefrontsize64
	...
	.long 0xb4                                                 // 000000000730: 000000B4
...
int_test:
	...
	v_mov_b32_e32 v5, v3                                       // 000000001914: 7E0A0303
	s_waitcnt lgkmcnt(0)                                       // 000000001918: BF8CC07F
	s_and_b32 s1, s4, 0xffff                                   // 00000000191C: 8701FF04 0000FFFF
	s_lshr_b32 s3, s4, 16                                      // 000000001924: 90039004
	s_mul_i32 s8, s8, s1                                       // 000000001928: 93080108
	s_mul_i32 s9, s9, s3                                       // 00000000192C: 93090309
	v_add3_u32 v2, s0, s8, v0                                  // 000000001930: D76D0002 04001000
	v_add3_u32 v4, s2, s9, v1                                  // 000000001938: D76D0004 04041202
	...
	v_lshlrev_b64 v[0:1], 3, v[2:3]                            // 000000001954: D6FF0000 00020483
	v_lshlrev_b64 v[4:5], 2, v[4:5]                            // 00000000195C: D6FF0004 00020882
	v_add_co_u32 v0, vcc_lo, v0, v4                            // 000000001964: D70F6A00 00020900
	v_add_co_ci_u32_e32 v1, vcc_lo, v1, v5, vcc_lo             // 00000000196C: 50020B01
	v_add_co_u32 v0, vcc_lo, v0, s0                            // 000000001970: D70F6A00 00000100
	v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo             // 000000001978: 50020201
	s_load_dwordx2 s[0:1], s[6:7], null                        // 00000000197C: F4040003 FA000000
	global_load_dword v4, v[0:1], off                          // 000000001984: DC308000 047D0000
	v_lshlrev_b64 v[0:1], 2, v[2:3]                            // 00000000198C: D6FF0000 00020482
	s_waitcnt lgkmcnt(0)                                       // 000000001994: BF8CC07F
	v_add_co_u32 v0, vcc_lo, s0, v0                            // 000000001998: D70F6A00 00020000
	v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo             // 0000000019A0: 50020201
	s_waitcnt vmcnt(0)                                         // 0000000019A4: BF8C3F70
	global_store_dword v[0:1], v4, off                         // 0000000019A8: DC708000 007D0400
	s_endpgm                                                   // 0000000019B0: BF810000
int_test_symend:
