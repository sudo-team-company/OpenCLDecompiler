...
int_test:
	...
	s_lshr_b32 s1, s10, 16                                     // 00000000191C: 9001900A
	s_mul_i32 s9, s9, s1                                       // 000000001920: 93090109
	s_and_b32 s1, s10, 0xffff                                  // 000000001924: 8701FF0A 0000FFFF
	...
	v_lshlrev_b64 v[3:4], 3, v[3:4]                            // 000000001940: D6FF0003 00020683
	v_mad_u64_u32 v[3:4], s0, v1, 24, v[3:4]                   // 000000001948: D5760003 040D3101
	s_getpc_b64 s[0:1]                                         // 000000001950: BE801F00
	s_add_u32 s0, s0, 0xffffeeac                               // 000000001954: 8000FF00 FFFFEEAC
	s_addc_u32 s1, s1, -1                                      // 00000000195C: 8201FF01 FFFFFFFF
