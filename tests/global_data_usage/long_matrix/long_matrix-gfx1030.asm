// llvm-mc -triple=amdgcn--amdhsa -mcpu=gfx1030 -mattr=+wavefrontsize32,+wavefrontsize64
	...
	.long 0xa8                                                 // 000000000730: 000000A8
...
int_test.kd:
	...
	.long 0x990                                                // 0000000007F4: 00000990
...
int_arr:
	...
	.long 0x2                                                  // 000000000808: 00000002
	.long 0                                                    // 00000000080C: 00000000
	.long 0x3                                                  // 000000000810: 00000003
	.long 0                                                    // 000000000814: 00000000
	.long 0x4                                                  // 000000000818: 00000004
	.long 0                                                    // 00000000081C: 00000000
	.long 0x5                                                  // 000000000820: 00000005
	.long 0                                                    // 000000000824: 00000000
	.long 0x6                                                  // 000000000828: 00000006
	.long 0                                                    // 00000000082C: 00000000
	.long 0x7                                                  // 000000000830: 00000007
	.long 0                                                    // 000000000834: 00000000
	.long 0x8                                                  // 000000000838: 00000008
	.long 0                                                    // 00000000083C: 00000000
	.ascii "	"                                                 // 000000000840: 09
	.byte 0                                                    // 000000000841: 00
	.short 0                                                   // 000000000842: 0000
...
int_test:
	s_load_dword s4, s[4:5], 0x4                               // 000000001900: F4000102 FA000004
	s_load_dwordx4 s[0:3], s[6:7], 0x10                        // 000000001908: F4080003 FA000010
	v_mov_b32_e32 v2, 0                                        // 000000001910: 7E040280
	v_mov_b32_e32 v4, v2                                       // 000000001914: 7E080302
	s_waitcnt lgkmcnt(0)                                       // 000000001918: BF8CC07F
	s_lshr_b32 s1, s4, 16                                      // 00000000191C: 90019004
	s_mul_i32 s9, s9, s1                                       // 000000001920: 93090109
	s_and_b32 s1, s4, 0xffff                                   // 000000001924: 8701FF04 0000FFFF
	v_add3_u32 v3, s2, s9, v1                                  // 00000000192C: D76D0003 04041202
	s_mul_i32 s8, s8, s1                                       // 000000001934: 93080108
	v_add3_u32 v1, s0, s8, v0                                  // 000000001938: D76D0001 04001000
	s_getpc_b64 s[0:1]                                         // 000000001940: BE801F00
	s_add_u32 s0, s0, 0xffffeebc                               // 000000001944: 8000FF00 FFFFEEBC
	s_addc_u32 s1, s1, -1                                      // 00000000194C: 8201FF01 FFFFFFFF
	v_lshlrev_b64 v[3:4], 3, v[3:4]                            // 000000001954: D6FF0003 00020683
	v_mad_u64_u32 v[3:4], null, v1, 24, v[3:4]                 // 00000000195C: D5767D03 040D3101
	v_lshlrev_b64 v[0:1], 3, v[1:2]                            // 000000001964: D6FF0000 00020283
	v_add_co_u32 v3, vcc_lo, v3, s0                            // 00000000196C: D70F6A03 00000103
	v_add_co_ci_u32_e32 v4, vcc_lo, s1, v4, vcc_lo             // 000000001974: 50080801
	s_load_dwordx2 s[0:1], s[6:7], null                        // 000000001978: F4040003 FA000000
	global_load_dwordx2 v[3:4], v[3:4], off                    // 000000001980: DC348000 037D0003
	s_waitcnt lgkmcnt(0)                                       // 000000001988: BF8CC07F
	v_add_co_u32 v0, vcc_lo, s0, v0                            // 00000000198C: D70F6A00 00020000
	v_add_co_ci_u32_e32 v1, vcc_lo, s1, v1, vcc_lo             // 000000001994: 50020201
	s_waitcnt vmcnt(0)                                         // 000000001998: BF8C3F70
	global_store_dwordx2 v[0:1], v[3:4], off                   // 00000000199C: DC748000 007D0300
	s_endpgm                                                   // 0000000019A4: BF810000
int_test_symend:
