// llvm-mc -triple=amdgcn--amdhsa -mcpu=gfx1030 -mattr=+wavefrontsize32,+wavefrontsize64
	...
	.long 0x84                                                 // 000000000738: 00000084
...
float_arr:
	...
	.long 0xc00ccccd                                           // 000000000808: C00CCCCD
	.long 0x4079999a                                           // 00000000080C: 4079999A
	.ascii "ff"                                                // 000000000810: 6666
	.short 0xc086                                              // 000000000812: C086
	.ascii "M"                                                 // 000000000814: 4D
	.byte 0xf3                                                 // 000000000815: F3
	.short 0x40a3                                              // 000000000816: 40A3
...
float_test:
	...
	global_store_dword v[0:1], v2, off                         // 000000001978: DC708000 007D0200
