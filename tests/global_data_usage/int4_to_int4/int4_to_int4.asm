/* Disassembling 'global_data_usage\int4_to_int4\int4_to_int4.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*00000000001c*/ v_lshlrev_b64   v[0:1], 4, v[0:1]
