...
int_test:
	...
	v_lshlrev_b64 v[4:5], 4, v[0:1]                            // 000000001940: D6FF0004 00020084
	v_add_co_u32 v0, vcc_lo, v4, s0                            // 000000001948: D70F6A00 00000104
	v_add_co_ci_u32_e32 v1, vcc_lo, s1, v5, vcc_lo             // 000000001950: 50020A01
	s_load_dwordx2 s[0:1], s[6:7], null                        // 000000001954: F4040003 FA000000
	global_load_dwordx4 v[0:3], v[0:1], off                    // 00000000195C: DC388000 007D0000
	s_waitcnt lgkmcnt(0)                                       // 000000001964: BF8CC07F
	v_add_co_u32 v4, vcc_lo, s0, v4                            // 000000001968: D70F6A04 00020800
	v_add_co_ci_u32_e32 v5, vcc_lo, s1, v5, vcc_lo             // 000000001970: 500A0A01
	s_waitcnt vmcnt(0)                                         // 000000001974: BF8C3F70
	global_store_dwordx4 v[4:5], v[0:3], off                   // 000000001978: DC788000 007D0004
