/* Disassembling 'branching_kernels\if_else_2_labels\if_else_2_labels-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
.kernel if_else_2_labels
    ...
    .control_directive
        .fill 128, 1, 0x00
    .config
        .md_symname "if_else_2_labels@kd"
...
/*00000000013c*/ s_and_saveexec_b32 s5, vcc_lo
/*000000000140*/ s_xor_b32       s5, exec_lo, s5
/*000000000144*/ v_mov_b32       v3, 0
/*000000000148*/ s_mul_i32       s4, s1, s0
/*00000000014c*/ s_or_saveexec_b32 s5, s5
/*000000000150*/ v_lshl_or_b32   v0, s7, 3, v1
/*000000000158*/ v_add_co_u32    v4, s[6:7], s10, v0
/*000000000160*/ v_mov_b32       v0, s4
/*000000000164*/ s_xor_b32       exec_lo, exec_lo, s5
/*000000000168*/ v_mul_lo_u32    v0, v4, s0
/*000000000170*/ v_mov_b32       v2, 1
/*000000000174*/ v_mov_b32       v3, 0
/*000000000178*/ v_subrev_nc_u32 v0, s1, v0
/*00000000017c*/ s_or_b32        exec_lo, exec_lo, s5
/*000000000180*/ v_mov_b32       v5, 0
/*000000000184*/ v_lshlrev_b64   v[1:2], 2, v[2:3]
/*00000000018c*/ v_lshlrev_b64   v[3:4], 2, v[4:5]
/*000000000194*/ v_mov_b32       v5, s0
/*000000000198*/ v_add_co_u32    v1, vcc, s2, v1
/*0000000001a0*/ v_add_co_ci_u32 v2, vcc, s3, v2, vcc
/*0000000001a4*/ v_add_co_u32    v3, vcc, s2, v3
/*0000000001ac*/ v_add_co_ci_u32 v4, vcc, s3, v4, vcc
/*0000000001b0*/ global_store_dword v[1:2], v0, off
/*0000000001b8*/ global_store_dword v[3:4], v5, off
