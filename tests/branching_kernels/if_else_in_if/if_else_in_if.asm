/* Disassembling 'branching_kernels\if_else_in_if\if_else_in_if.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*00000000003c*/ s_lshl_b32      s3, s7, 2
...
/*000000000084*/ s_lshl_b32      s3, s8, 2
...
/*0000000000e4*/ v_lshlrev_b64   v[0:1], 2, v[3:4]
/*0000000000ec*/ s_waitcnt       lgkmcnt(0)
/*0000000000f0*/ v_add_u32       v0, vcc, s0, v0
/*0000000000f4*/ v_mov_b32       v2, s1
/*0000000000f8*/ v_addc_u32      v1, vcc, v2, v1, vcc
/*0000000000fc*/ v_mov_b32       v2, s2
/*000000000100*/ flat_store_dword v[0:1], v2
