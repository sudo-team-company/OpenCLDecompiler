/* Disassembling 'branching_kernels\if_else_in_if\if_else_in_if-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
/*000000000140*/ s_cbranch_execz .L492_0
...
/*000000000194*/ s_waitcnt_decptr 0xffe3
/*000000000198*/ s_xor_b32       exec_lo, exec_lo, s6
/*00000000019c*/ s_cbranch_execz .L492_0
/*0000000001a0*/ s_load_dwordx2  s[6:7], s[10:11], 0x10
/*0000000001a8*/ s_load_dword    s4, s[4:5], 0x0
/*0000000001b0*/ v_lshl_or_b32   v1, s8, 2, v2
/*0000000001b8*/ s_waitcnt       lgkmcnt(0)
/*0000000001bc*/ v_add_co_u32    v1, s[5:6], s6, v1
/*0000000001c4*/ v_mov_b32       v3, s4
/*0000000001c8*/ v_add_co_ci_u32 v2, s[5:6], s7, 0, s[5:6]
/*0000000001d0*/ v_lshlrev_b64   v[1:2], 2, v[1:2]
/*0000000001d8*/ v_add_co_u32    v1, vcc, s2, v1
/*0000000001e0*/ v_add_co_ci_u32 v2, vcc, s3, v2, vcc
/*0000000001e4*/ global_store_dword v[1:2], v3, off
.L492_0:
/*0000000001ec*/ s_waitcnt_decptr 0xffe3
/*0000000001f0*/ s_or_b32        exec_lo, exec_lo, s1
/*0000000001f4*/ v_mov_b32       v1, 0
/*0000000001f8*/ v_mov_b32       v2, s0
/*0000000001fc*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*000000000204*/ v_add_co_u32    v0, vcc, s2, v0
/*00000000020c*/ v_add_co_ci_u32 v1, vcc, s3, v1, vcc
/*000000000210*/ global_store_dword v[0:1], v2, off
/*000000000218*/ s_endpgm
