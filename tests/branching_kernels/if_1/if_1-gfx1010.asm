/* Disassembling 'branching_kernels\if_1\if_1-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
.L368_0:
/*000000000170*/ s_waitcnt_decptr 0xffe3
/*000000000174*/ s_or_b32        exec_lo, exec_lo, s1
/*000000000178*/ v_mov_b32       v1, 0
/*00000000017c*/ v_mov_b32       v2, s0
/*000000000180*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*000000000188*/ v_add_co_u32    v0, vcc, s2, v0
/*000000000190*/ v_add_co_ci_u32 v1, vcc, s3, v1, vcc
/*000000000194*/ global_store_dword v[0:1], v2, off
/*00000000019c*/ s_endpgm
