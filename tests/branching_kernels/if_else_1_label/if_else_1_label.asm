/* Disassembling 'branching_kernels\if_else_1_label\if_else_1_label.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*000000000024*/ v_cmp_eq_i32    vcc, 2, v0
...
/*00000000006c*/ v_subrev_u32    v6, vcc, s1, v3
.L112_0:
/*000000000070*/ s_andn2_b64     exec, s[4:5], exec
/*000000000074*/ s_waitcnt       lgkmcnt(0)
/*000000000078*/ v_mul_lo_u32    v6, v0, s1
...
/*000000000094*/ v_addc_u32      v1, vcc, v4, v1, vcc
/*000000000098*/ s_mov_b64       exec, s[4:5]
/*00000000009c*/ v_mov_b32       v3, 0
/*0000000000a0*/ v_lshlrev_b64   v[2:3], 2, v[2:3]
/*0000000000a8*/ v_add_u32       v2, vcc, s2, v2
/*0000000000ac*/ v_mov_b32       v5, s3
/*0000000000b0*/ v_addc_u32      v3, vcc, v5, v3, vcc
/*0000000000b4*/ v_mov_b32       v5, s0
/*0000000000b8*/ flat_store_dword v[0:1], v6
/*0000000000c0*/ flat_store_dword v[2:3], v5
