/* Disassembling 'branching_kernels\if_else_1_label\if_else_1_label-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
/*000000000138*/ v_cmp_lg_u32    vcc, 2, v2
/*00000000013c*/ s_and_saveexec_b32 s4, vcc_lo
/*000000000140*/ s_xor_b32       s4, exec_lo, s4
/*000000000144*/ v_mul_lo_u32    v0, v2, s1
/*00000000014c*/ v_mov_b32       v3, 0
/*000000000150*/ s_or_saveexec_b32 s4, s4
/*000000000154*/ v_lshl_or_b32   v1, s7, 3, v1
/*00000000015c*/ v_add_co_u32    v4, s[5:6], s10, v1
/*000000000164*/ s_xor_b32       exec_lo, exec_lo, s4
/*000000000168*/ v_mul_lo_u32    v0, v4, s0
/*000000000170*/ v_mov_b32       v2, 2
/*000000000174*/ v_mov_b32       v3, 0
/*000000000178*/ v_subrev_nc_u32 v0, s1, v0
/*00000000017c*/ s_or_b32        exec_lo, exec_lo, s4
