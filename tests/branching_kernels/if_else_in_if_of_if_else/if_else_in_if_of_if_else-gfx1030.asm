/* Disassembling 'branching_kernels\if_else_in_if_of_if_else\if_else_in_if_of_if_else-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
.kernel if_else_in_if_else
    ...
    .control_directive
        .fill 128, 1, 0x00
    .config
        .md_symname "if_else_in_if_else@kd"
