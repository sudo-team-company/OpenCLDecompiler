/* Disassembling 'branching_kernels\if_else_in_else_of_if_else_gfx\if_else_in_else_of_if_else_gfx-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
/*00000000046c*/ s_cbranch_execz .L1236_0
...
/*0000000004b8*/ s_waitcnt_decptr 0xffe3
/*0000000004bc*/ s_xor_b32       exec_lo, exec_lo, s5
/*0000000004c0*/ v_mov_b32       v4, 0
/*0000000004c4*/ v_add_nc_u32    v2, s2, v3
/*0000000004c8*/ v_mov_b32       v5, v4
/*0000000004cc*/ v_mov_b32       v4, v3
/*0000000004d0*/ s_or_b32        exec_lo, exec_lo, s5
.L1236_0:
/*0000000004d4*/ s_or_saveexec_b32 s4, s4
/*0000000004d8*/ s_xor_b32       exec_lo, exec_lo, s4
/*0000000004dc*/ v_mul_lo_u32    v0, v0, s2
/*0000000004e4*/ v_mov_b32       v4, 1
/*0000000004e8*/ v_mov_b32       v5, 0
/*0000000004ec*/ v_subrev_nc_u32 v2, s3, v0
/*0000000004f0*/ s_or_b32        exec_lo, exec_lo, s4
/*0000000004f4*/ v_lshlrev_b64   v[0:1], 2, v[4:5]
/*0000000004fc*/ v_add_co_u32    v0, vcc, s0, v0
/*000000000504*/ v_add_co_ci_u32 v1, vcc, s1, v1, vcc
/*000000000508*/ global_store_dword v[0:1], v2, off
