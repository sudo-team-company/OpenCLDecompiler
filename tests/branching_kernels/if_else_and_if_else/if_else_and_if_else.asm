/* Disassembling 'branching_kernels\if_else_and_if_else\if_else_and_if_else.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*000000000020*/ v_add_u32       v6, vcc, s1, v1
...
/*00000000005c*/ v_mov_b32       v4, s3
/*000000000060*/ v_addc_u32      v1, vcc, v4, v1, vcc
/*000000000064*/ v_mul_lo_u32    v4, v6, s1
/*00000000006c*/ v_subrev_u32    v4, vcc, s0, v4
.L112_0:
/*000000000070*/ s_andn2_b64     exec, s[6:7], exec
/*000000000074*/ s_waitcnt       lgkmcnt(0)
/*000000000078*/ v_mul_lo_u32    v4, v0, s0
/*000000000080*/ v_mov_b32       v1, 0
/*000000000084*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*00000000008c*/ v_add_u32       v0, vcc, s2, v0
/*000000000090*/ v_mov_b32       v5, s3
/*000000000094*/ v_addc_u32      v1, vcc, v5, v1, vcc
/*000000000098*/ s_mov_b64       exec, s[6:7]
/*00000000009c*/ flat_store_dword v[0:1], v4
/*0000000000a4*/ s_lshl_b32      s6, s8, 2
/*0000000000a8*/ s_min_i32       s0, s1, s0
/*0000000000ac*/ v_mov_b32       v4, s3
/*0000000000b0*/ v_mov_b32       v5, s0
/*0000000000b4*/ v_mov_b32       v7, 0
/*0000000000b8*/ v_lshlrev_b64   v[0:1], 2, v[6:7]
/*0000000000c0*/ v_add_u32       v8, vcc, s2, v0
/*0000000000c4*/ v_addc_u32      v9, vcc, v4, v1, vcc
/*0000000000c8*/ v_mov_b32       v7, s1
/*0000000000cc*/ s_load_dwordx2  s[0:1], s[4:5], 0x10
/*0000000000d4*/ s_waitcnt       lgkmcnt(0)
/*0000000000d8*/ s_add_u32       s0, s6, s0
/*0000000000dc*/ v_add_u32       v0, vcc, s0, v2
/*0000000000e0*/ v_mov_b32       v1, 0
/*0000000000e4*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*0000000000ec*/ v_add_u32       v0, vcc, s2, v0
/*0000000000f0*/ v_addc_u32      v1, vcc, v4, v1, vcc
/*0000000000f4*/ flat_store_dword v[0:1], v5
/*0000000000fc*/ flat_store_dword v[8:9], v7
