/* Disassembling 'branching_kernels\if_else_in_if_of_if_else_gfx\if_else_in_if_of_if_else_gfx-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
/*000000000454*/ s_cbranch_execz .L1240_0
...
/*0000000004c0*/ s_waitcnt_decptr 0xffe3
/*0000000004c4*/ s_xor_b32       exec_lo, exec_lo, s3
/*0000000004c8*/ v_add_nc_u32    v3, s4, v1
/*0000000004cc*/ v_mov_b32       v0, v1
/*0000000004d0*/ v_mov_b32       v1, v2
/*0000000004d4*/ s_or_b32        exec_lo, exec_lo, s3
.L1240_0:
/*0000000004d8*/ s_or_b32        exec_lo, exec_lo, s2
/*0000000004dc*/ v_mov_b32       v1, 0
/*0000000004e0*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*0000000004e8*/ v_add_co_u32    v0, vcc, s0, v0
/*0000000004f0*/ v_add_co_ci_u32 v1, vcc, s1, v1, vcc
/*0000000004f4*/ global_store_dword v[0:1], v3, off
/*0000000004fc*/ s_endpgm
