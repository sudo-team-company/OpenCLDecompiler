/* Disassembling 'branching_kernels\if_in_if\if_in_if-gfx1030.bin' */
.rocm
.gpu GFX1000
.arch_minor 3
.arch_stepping 0
...
.L472_0:
/*0000000001d8*/ s_or_b32        exec_lo, exec_lo, s1
/*0000000001dc*/ v_mov_b32       v1, 0
/*0000000001e0*/ v_mov_b32       v2, s0
/*0000000001e4*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*0000000001ec*/ v_add_co_u32    v0, vcc, s2, v0
/*0000000001f4*/ v_add_co_ci_u32 v1, vcc, s3, v1, vcc
/*0000000001f8*/ global_store_dword v[0:1], v2, off
