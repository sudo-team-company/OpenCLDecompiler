/* Disassembling 'branching_kernels\if_in_if\if_in_if-gfx1010.bin' */
.rocm
.gpu GFX1010
.arch_minor 1
.arch_stepping 0
...
/*000000000128*/ v_add_co_u32    v0, s[1:2], s10, v0
/*000000000130*/ s_add_u32       s10, s4, 24
/*000000000134*/ s_addc_u32      s11, s5, 0
/*000000000138*/ v_cmp_eq_u32    vcc, 0, v0
/*00000000013c*/ s_and_saveexec_b32 s1, vcc_lo
/*000000000140*/ s_cbranch_execz .L472_0
/*000000000144*/ s_load_dword    s6, s[10:11], 0x8
/*00000000014c*/ s_lshl_b32      s7, s7, 2
/*000000000150*/ v_mov_b32       v4, 0
/*000000000154*/ s_waitcnt       lgkmcnt(0)
/*000000000158*/ v_add3_u32      v3, s6, s7, v1
/*000000000160*/ v_lshlrev_b64   v[3:4], 2, v[3:4]
/*000000000168*/ v_add_co_u32    v3, vcc, s2, v3
/*000000000170*/ v_add_co_ci_u32 v4, vcc, s3, v4, vcc
/*000000000174*/ global_load_dword v1, v[3:4], off
/*00000000017c*/ s_waitcnt       vmcnt(0)
/*000000000180*/ v_cmp_gt_i32    vcc, s0, v1
/*000000000184*/ s_and_b32       exec_lo, exec_lo, vcc_lo
/*000000000188*/ s_cbranch_execz .L472_0
/*00000000018c*/ s_load_dwordx2  s[6:7], s[10:11], 0x10
/*000000000194*/ s_load_dword    s4, s[4:5], 0x0
/*00000000019c*/ v_lshl_or_b32   v1, s8, 2, v2
/*0000000001a4*/ s_waitcnt       lgkmcnt(0)
/*0000000001a8*/ v_add_co_u32    v1, s[5:6], s6, v1
/*0000000001b0*/ v_mov_b32       v3, s4
/*0000000001b4*/ v_add_co_ci_u32 v2, s[5:6], s7, 0, s[5:6]
/*0000000001bc*/ v_lshlrev_b64   v[1:2], 2, v[1:2]
/*0000000001c4*/ v_add_co_u32    v1, vcc, s2, v1
/*0000000001cc*/ v_add_co_ci_u32 v2, vcc, s3, v2, vcc
/*0000000001d0*/ global_store_dword v[1:2], v3, off
.L472_0:
/*0000000001d8*/ s_waitcnt_decptr 0xffe3
/*0000000001dc*/ s_or_b32        exec_lo, exec_lo, s1
/*0000000001e0*/ v_mov_b32       v1, 0
/*0000000001e4*/ v_mov_b32       v2, s0
/*0000000001e8*/ v_lshlrev_b64   v[0:1], 2, v[0:1]
/*0000000001f0*/ v_add_co_u32    v0, vcc, s2, v0
/*0000000001f8*/ v_add_co_ci_u32 v1, vcc, s3, v1, vcc
/*0000000001fc*/ global_store_dword v[0:1], v2, off
