/* Disassembling 'branching_kernels\if_else_in_else_of_if_else\if_else_in_else_of_if_else.bin' */
.amdcl2
.gpu Iceland
.64bit
.arch_minor 0
...
/*000000000048*/ v_mul_lo_u32    v1, v7, s1
/*000000000050*/ v_subrev_u32    v2, vcc, s0, v1
/*000000000054*/ v_mov_b32       v6, 0
/*000000000058*/ s_andn2_b64     exec, s[6:7], exec
/*00000000005c*/ s_cbranch_execz .L192_0
/*000000000060*/ s_load_dwordx2  s[4:5], s[4:5], 0x10
/*000000000068*/ v_mul_lo_u32    v4, v5, s0
/*000000000070*/ v_mov_b32       v6, 0
/*000000000074*/ v_lshlrev_b64   v[0:1], 2, v[5:6]
/*00000000007c*/ s_waitcnt       lgkmcnt(0)
/*000000000080*/ s_lshl_b32      s5, s8, 2
/*000000000084*/ v_add_u32       v0, vcc, s2, v0
/*000000000088*/ v_mov_b32       v5, s3
/*00000000008c*/ v_addc_u32      v1, vcc, v5, v1, vcc
/*000000000090*/ v_add_u32       v2, vcc, s5, v2
/*000000000094*/ s_cmp_ge_i32    s1, s0
/*000000000098*/ s_cselect_b64   s[8:9], exec, 0
/*00000000009c*/ s_add_u32       s5, s4, s1
/*0000000000a0*/ v_add_u32       v5, vcc, s4, v2
/*0000000000a4*/ v_add_u32       v2, vcc, s5, v2
/*0000000000a8*/ v_add_u32       v6, vcc, s0, v7
/*0000000000ac*/ flat_store_dword v[0:1], v4
/*0000000000b4*/ v_cndmask_b32   v2, v2, v6, s[8:9]
