...
class VCvt(BaseInstruction):
    def __init__(self, node, suffix):
        ...
        self.from_registers = name_of_from + str(first_from)
        self.to_registers = name_of_to + str(first_to)
    ...
    def to_fill_node(self):
        if self.suffix in ['f32_u32', 'f64_i32', 'f64_u32', 'i32_f64', 'u32_f64', 'i32_f32', 'f32_i32']:
            ...
            return make_new_value_for_reg(self.node, new_value, self.to_registers, [], asm_type, reg_type=reg_type)
        else:
