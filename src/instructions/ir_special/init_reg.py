    ...
    def to_fill_node(self):
        ...
        if match:
            ...
            reg_type_map = {
                ...
                "get_local_id": [RegisterType.WORK_ITEM_ID_X, RegisterType.WORK_ITEM_ID_Y, RegisterType.WORK_ITEM_ID_Z],
                "get_global_offset": [
                    RegisterType.GLOBAL_OFFSET_X,
                    RegisterType.GLOBAL_OFFSET_Y,
                    RegisterType.GLOBAL_OFFSET_Z,
                ],
                "get_num_groups": [RegisterType.NUM_GROUPS_X, RegisterType.NUM_GROUPS_Y, RegisterType.NUM_GROUPS_Z],
                "get_local_size": [RegisterType.LOCAL_SIZE_X, RegisterType.LOCAL_SIZE_Y, RegisterType.LOCAL_SIZE_Z],
            }
